<!-- MODAL PARA VER Y EDITAR LA INFORMACIÓN DEL EMPLEADO -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="p-3 bg-white rounded-3 border h-100 shadow-sm">
                                ...
                                <div class="mt-3 alert alert-warning py-2 small border-0 mb-2">
                                    <i class="bi bi-info-circle-fill me-2"></i> Selecciona la fecha base para los días laborados.
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold small" for="dias_aguinaldo">Días de Aguinaldo</label>
                                        <div class="input-group">
                                            <span class="input-group-text bg-light"><i class="bi bi-currency-dollar"></i></span>
                                            <input type="number" class="form-control shadow-sm" id="dias_aguinaldo" name="dias_aguinaldo" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-outline-secondary" type="button" id="btn_resetear_isr"><i class="bi bi-arrow-clockwise"></i></button>
                                        </div>
                                    </div>
