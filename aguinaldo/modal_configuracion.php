    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-light bg-opacity-50 transition-hover h-100">
                                            <label for="archivo_ausencias" class="form-label d-flex align-items-center fw-semibold">
                                                ...
                                                Ausencias en Lista de Raya Citricos SAAO
                                            </label>
                                            <p class="text-muted mb-2" style="font-size: 0.75rem;">Incidencias y faltas para SAAO.</p>
                                            <input accept=".xls, .xlsx" class="form-control form-control-sm border-dashed shadow-sm" type="file" id="archivo_ausencias" name="archivo_ausencias">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-light bg-opacity-50 transition-hover h-100">
                                            <label for="archivo_ausencias_sb" class="form-label d-flex align-items-center fw-semibold">
                                                ...
                                                Ausencias en Lista de Raya SB CITRIC'S
                                            </label>
                                            <p class="text-muted mb-2" style="font-size: 0.75rem;">Incidencias y faltas para SB.</p>
                                            <input accept=".xls, .xlsx" class="form-control form-control-sm border-dashed shadow-sm" type="file" id="archivo_ausencias_sb" name="archivo_ausencias_sb">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Cuerpo para configurar fechas y ausencias -->
                <div class="card shadow d-none" id="cuerpo_tabla_configuracion">
                    <div class="card-body">
                        <form method="post" id="form_tabla_configuracion" enctype="multipart/form-data">
                                ...
                                <table class="table table-sm table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="fs-6 text-uppercase">Fecha Real</th>
                                            <th class="fs-6 text-uppercase">Fecha Imss</th>
                                            <th class="fs-6 text-uppercase">Ausencias</th>
                                            <th class="fs-6 text-uppercase">Fecha Pago</th>
                                        </tr>
                            ...
                            <!-- Elemento para rastrear la página actual -->
                            <div id="pagina_actual_configuracion" data-pagina="1"></div>

                            <!-- Paginación -->
                            <nav aria-label="Page navigation" id="contenedor_paginacion_configuracion">
                                <ul class="pagination justify-content-center" id="paginacion_configuracion">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <!-- Lado Izquierdo: Select -->
                                <div style="min-width: 250px;">
                                    <select id="departamento_configuracion" class="form-select border border-success">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-outline-secondary fw-bold" id="btn_volver_cargar_configuracion">
                                        <i class="bi bi-arrow-clockwise me-2"></i>Volver a cargar
                                    </button>
                                    <button type="submit" class="btn btn-primary fw-bold">
                                        <i class="bi bi-box-arrow-in-down me-2"></i>Guardar cambios
                                    </button>
                                </div>
                            </div>
                        </form>
