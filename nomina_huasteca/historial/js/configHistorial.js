...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#detalle-tabla-nomina-body-huasteca tr', function (e) {
...
function regresarHistorialHuasteca() {

    $('#btnRegresar').on('click', function () {
        // Redirigir a la vista historial_huasteca
        window.location.href = "historial_huasteca.php";

        // Limpiar el localStorage
        localStorage.removeItem('id_nomina_huasteca');
