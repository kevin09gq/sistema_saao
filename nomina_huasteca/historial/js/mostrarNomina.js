...
function obtenerIdNomina() {
    ...
    return parametros.get('id_nomina_huasteca');
...
function obtenerNomina() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonHistorialHuasteca = nomina.nomina_huasteca;
...
function llenarTablaNominaHistorial() {
    ...
    $('#detalle-tabla-nomina-body-huasteca').empty();

    // Obtener el departamento seleccionado
    let filtro = $('#detalle-filtro-departamento').val();

    // Obtener el texto escrito en el buscador
    let textoBusqueda = $('#detalle-busqueda-nomina-huasteca').val().trim().toUpperCase();
    ...
    jsonHistorialHuasteca.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#detalle-tabla-nomina-body-huasteca').append(`
    ...
    let deptoSeleccionado = jsonHistorialHuasteca.departamentos.find(d => d.id_departamento == idDepartamento);
    ...
    actualizarCabeceraNomina(jsonHistorialHuasteca)
...
function calcularTotalesPorColumna() {
    ...
    $('#detalle-tabla-nomina-foot-huasteca').empty();
    ...
    $('#detalle-tabla-nomina-foot-huasteca').append(`
        <tr>
