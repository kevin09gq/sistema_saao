...
function veficarExistenciaNomina() {
    ...
    var idNomina = localStorage.getItem('id_nomina_huasteca');
    ...
    if (idNomina) {
        ...
        window.location.href = url + '?id_nomina_huasteca=' + idNomina;
...
function mostrarNominas() {
    ...
    $.each(registros, function (indice, nomina) {
        ...
        $('#tbody-historial-nominas').append(
            ...
            'data-id="' + nomina.id_nomina_huasteca + '" ' +
            'title="Ver nómina">' +
...
function verNomina(idNomina) {
    ...
    localStorage.setItem('id_nomina_huasteca', idNomina);
