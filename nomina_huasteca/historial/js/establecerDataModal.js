...
function establecerDataEmpleado(empleado) {
    ...
    establecerEventosEntradasTempranas(empleado, jsonHistorialHuasteca);
    establecerEventosSalidasTardias(empleado, jsonHistorialHuasteca);
    establecerEventosSalidasTempranas(empleado, jsonHistorialHuasteca);
    establecerEventosRetardos(empleado, jsonHistorialHuasteca);
    establecerEventosAusentismos(empleado, jsonHistorialHuasteca);
    establecerEventosComidaExtra(empleado, jsonHistorialHuasteca);
    establecerEventosMarcajes(empleado, jsonHistorialHuasteca);
...
function ocultarComponentesModalDetalles(empleado) {
    ...
    let departamentoEmpleado = jsonHistorialHuasteca.departamentos.find(function (departamento) {
