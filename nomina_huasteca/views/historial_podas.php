...
<head>
    ...
    <title>Historial Podas - Huasteca</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="header-historial">
            <h2><i class="bi bi-clock-history me-2"></i> Historial de Nóminas (Huasteca)</h2>
            <a href="nomina_huasteca.php" class="btn btn-light btn-sm text-success fw-bold">
