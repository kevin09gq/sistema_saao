...
$encabezados_corte = [
    ...
    'N' => 'FIRMA' // Columna para la firma de recibido
];
...
function crearHoja($spreadsheet, $titulo2, $filtroEmpleados, $nombreHoja, $colorExcel = '32BA5B')
{
...
function crearHojaCorte($spreadsheet, $titulo2, $jsonNomina, $nombreHoja)
{
    ...
    $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(24)->getColor()->setRGB('32BA5B');
    ...
    $sheet->getStyle('A6:N6')->getFill()->getStartColor()->setRGB('32BA5B'); // Rojo
...
function crearHojaPoda($spreadsheet, $titulo2, $jsonNomina, $nombreHoja = 'PODA')
{
    ...
    // COLORES PARA USAR
    // ==========================
    $color_primario = '32BA5B';  // Color primario Rojo
