...
$tmp_nombre = 'SEM ' . $jsonNomina['numero_semana'] . ' - ' . date('Y') . ' RANCHO HUASTECA NOMINAS - PODA DE ARBOLES - ' . date('Y-m-d_H-i-s');
...
$sheet->getStyle('A6:N6')->getFont()->setColor(new Color($color_negro)); // Letra NEGRO
