...
$pdf->SetTitle('Tickets de Nómina Huasteca');
...
if (empty($departamento)) {
    $nombreArchivo = 'SEM_' . $semana . '_HUASTECA_' . $año . '.pdf';
} else {
    $nombreArchivo = 'SEM_' . $semana . '_' . strtoupper($departamento) . '_HUASTECA_' . $año . '.pdf';
}
