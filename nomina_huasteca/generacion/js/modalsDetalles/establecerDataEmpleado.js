...
function establecerDataEmpleado(empleado) {
 ...
 // Establecer Dias Trabajados
    ...
    establecerEventosEntradasTempranas(empleado, jsonNominaHuasteca);
    establecerEventosSalidasTardias(empleado, jsonNominaHuasteca);
    establecerEventosSalidasTempranas(empleado, jsonNominaHuasteca);
    establecerEventosRetardos(empleado, jsonNominaHuasteca);
    establecerEventosAusentismos(empleado, jsonNominaHuasteca);
    establecerEventosComidaExtra(empleado, jsonNominaHuasteca);
    establecerEventosMarcajes(empleado, jsonNominaHuasteca);
