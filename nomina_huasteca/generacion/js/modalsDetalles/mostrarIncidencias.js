...
//==========================================================
function obtenerDatosNominaHuasteca(dataNomina = null) {
    if (dataNomina && dataNomina.departamentos) {
        return dataNomina;
    }
    if (typeof jsonNominaHuasteca !== 'undefined' && jsonNominaHuasteca && jsonNominaHuasteca.departamentos) {
        return jsonNominaHuasteca;
    }
    if (typeof jsonHistorialHuasteca !== 'undefined' && jsonHistorialHuasteca && jsonHistorialHuasteca.departamentos) {
        return jsonHistorialHuasteca;
    }
    return null;
}
...
//==========================================================
function obtenerHorarioEmpleadoHuasteca(empleado, dataNomina = null) {
    if (!empleado) return [];
    let data = obtenerDatosNominaHuasteca(dataNomina);
...
//==========================================================
function obtenerDepartamentoEmpleadoHuasteca(empleado, dataNomina = null) {
...
function establecerEventosOlvidosBiometrico(data) {
    ...
    // Limpiar contenedor
    $("#olvidos-checador-huasteca").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#olvidos-checador-huasteca").html(`
            <div class="text-muted text-center">
                No hubo olvidos.
            </div>
        `);

        $("#total-olvidos-checador-huasteca").text(0);
    ...
    registros.forEach((registro) => {
        ...
        if (registro.entrada === "" || registro.salida === "") {
            ...
            $("#olvidos-checador-huasteca").append(`
    ...
    // Mostrar total
    $("#total-olvidos-checador-huasteca").text(totalOlvidos);
...
function establecerEventosEntradasTempranas(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#entradas-tempranas-huasteca").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#entradas-tempranas-huasteca").html(`
            <div class="text-muted text-center">
                No hubo entradas tempranas.
            </div>
        `);

        $("#total-entradas-tempranas-huasteca").text("00:00");

        return;
    }

    // obtener el horario según el tipo de horario del departamento
    let tipoHorario = obtenerHorarioEmpleadoHuasteca(empleado, dataNomina);
    ...
    registros.forEach(function (registro) {
        ...
        if (entradaEmpleado <= limiteEntradaTemprana) {
            ...
            $("#entradas-tempranas-huasteca").append(`
                <div class="small py-1 border-bottom">
    ...
    $("#total-entradas-tempranas-huasteca")
...
function establecerEventosSalidasTardias(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#salidas-tardias-huasteca").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tardias-huasteca").html(`
            <div class="text-muted text-center">
                No hubo salidas tardías.
            </div>
        `);

        $("#total-salidas-tardias-huasteca").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (salidaEmpleado >= limiteSalidaTardia) {
            ...
            $("#salidas-tardias-huasteca").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tardias-huasteca")
...
function establecerEventosSalidasTempranas(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#salidas-tempranas-huasteca").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tempranas-huasteca").html(`
            <div class="text-muted text-center">
        ...
        $("#total-salidas-tempranas-huasteca").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (minutosAntes >= 5) {
            ...
            $("#salidas-tempranas-huasteca").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tempranas-huasteca")
...
function establecerEventosRetardos(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#retardos-huasteca").html(`
            <div class="text-muted text-center">
                No hubo retardos.
            </div>
        `);

        $("#total-retardos-huasteca").text("00:00");
...
function establecerEventosAusentismos(empleado, dataNomina = null) {
    ...
    // limpiar contenedor
    $("#inasistencias-content-huasteca").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#inasistencias-content-huasteca").html(`
            <div class="text-success text-center">
                Sin ausentismos.
            </div>
        `);

        $("#total-inasistencias-huasteca").text(0);
    ...
    registros.forEach(function (registro) {
        ...
        if (
            ...
            $("#inasistencias-content-huasteca").append(`
                <div class="small py-1 border-bottom">
...
function establecerEventosComidaExtra(empleado, dataNomina = null) {
    ...
    if (registros.length == 0) {
        ...
        $("#comida-huasteca").html(`
            <div class="text-muted text-center">
                Sin comida extra.
            </div>
        `);

        $("#total-comida-huasteca").text("00:00");

        return;
    }

    // validar que el empleado tenga horario oficial
    let horarioOficial = obtenerHorarioEmpleadoHuasteca(empleado, dataNomina) || [];
...
function establecerEventosMarcajes(empleado, dataNomina = null) {
    ...
    if (registros.length == 0) {
        ...
        $("#marcajes-huasteca").html(`
            <div class="text-muted text-center">
                Sin marcajes excedentes.
            </div>
        `);

        $("#total-marcajes-huasteca").text(0);

        return;
    }

    // buscar el departamento del empleado
    let departamentoEmpleado = obtenerDepartamentoEmpleadoHuasteca(empleado, dataNomina);
    ...
    let horarioEmpleado = obtenerHorarioEmpleadoHuasteca(empleado, dataNomina);
