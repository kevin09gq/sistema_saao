        ...
        $.ajax({
            ...
            success: function (res) {
                try {
                    ...
                    unirBiometricoConSeleccionados(jsonNominaHuasteca, JsonBiometrico, clavesSeleccionadas);
                    ...
                    clavesSeleccionadas.forEach(obj => {
                        ...
                        // Si es coordinador (id_departamento === 12), recalcular eventos
                        if (parseInt(emp.id_departamento) === 12) {
                        ...
                        else if (parseInt(emp.id_departamento) === 13) {
                            // Verificar si existe horarioRancho
                            if (!jsonNominaHuasteca.horarioRancho || !Array.isArray(jsonNominaHuasteca.horarioRancho)) {
...
function obtenerEmpleadoPorClave(clave, id_empresa) {
    ...
    for (const depto of jsonNominaHuasteca.departamentos) {
...
function unirBiometricoConSeleccionados(jsonNominaHuasteca, JsonBiometrico, clavesSeleccionadas) {
