...
function limpiarModalDetallesNominaEmpleado() {
    ...
    $('#campo-minutos-trabajados-huasteca').text('');

    $('#campo-minutos-extras-huasteca').text('');
    ...
    $('#total-entradas-tempranas-huasteca').text('0');

    $('#total-salidas-tardias-huasteca').text('0');

    $('#total-salidas-tempranas-huasteca').text('0');

    $('#total-olvidos-checador-huasteca').text('0');

    $('#total-retardos-huasteca').text('0');

    $('#total-inasistencias-huasteca').text('0');

    $('#total-comida-huasteca').text('0');
