...
function llenarSelectoresDelModal() {
    ...
    $.each(jsonNominaHuasteca.departamentos, function (indice, departamento) {
...
function mostrarInformacionDelEmpleado(claveBuscada) {
    ...
    let departamentoActual = jsonNominaHuasteca.departamentos.find(dept => 
...
function verificarCompatibilidadHorarios() {
    ...
    let departamentoObjetivo = jsonNominaHuasteca.departamentos.find(d => d.id_departamento == idDepartamentoDestino);
...
function moverEmpleadoNuevoDepartamento() {
    ...
    let departamentoDestino = jsonNominaHuasteca.departamentos.find(d => d.id_departamento == idDestino);
