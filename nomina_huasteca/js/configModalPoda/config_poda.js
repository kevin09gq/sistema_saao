 ...
 * @param {Object} json El jsonNominaHuasteca completo de nómina del Relicario
...
$(document).on('change', '#dia_semana_poda', function (e) {
    ...
    let fechas = obtenerRangoFechas(
        jsonNominaHuasteca.fecha_inicio,
        jsonNominaHuasteca.fecha_cierre,
        false
    );
...
function guardar_poda(nombre_empleado, fecha_poda, arboles_podados, pago_arbol) {
    ...
    let nuevoMovimiento = {
        'id': obtenerSiguienteIdPoda(jsonNominaHuasteca),
        'concepto': 'PODA',
        'fecha': fecha_poda,
