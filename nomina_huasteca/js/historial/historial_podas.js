...
function abrirDetallesPoda(index, desdeRanking = false) {
    ...
    // En Mixto, si el registro es solo extra (sin árboles), ocultar la tarjeta de árboles
    const esSoloExtra = (tabActual === 'extras' || (tabActual === 'general' && parseInt(poda.total_arboles || 0) === 0));
...
function generarPDFPodaCorporativo(poda) {
    ...
    doc.text('Rancho Huasteca', PAGE_W / 2, y, { align: 'center' });
