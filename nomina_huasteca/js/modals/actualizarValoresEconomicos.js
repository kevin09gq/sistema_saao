...
function abrirModalActualizarValores() {
    ...
    $('#btn_actualizar_valores_huasteca').click(function () {
...
function establecerValores() {
    // Establecer los valores en los campos del modal
    $('#precio_pasaje_actualizar').val(jsonNominaHuasteca.precio_pasaje);
    $('#pago_comida_actualizar').val(jsonNominaHuasteca.pago_comida);
    $('#pago_tardeada_actualizar').val(jsonNominaHuasteca.pago_tardeada);
}
...
function guardarValoresActualizados() {
    $("#btn_guardar_valores").click(function (e) {
        ...
        // Actualizar en el JsonNominaHuasteca
