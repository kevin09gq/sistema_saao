        ...
        <div class="modal-content">
                ...
                <div class="mb-3">
                    <div class="mb-2">
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-1 align-items-center">
                            ...
                            <select class="form-select form-select-sm w-auto" id="filtro_departamento_ticket_relicario">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-secondary" id="btn_generar_tickets_nombre_seleccionados">
                    <i class="bi bi-person-badge"></i> Ticket Nombre (<span id="contador_nombre_btn">0</span>)
                </button>
