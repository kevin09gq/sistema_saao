...
function limpiarModalDetallesNominaEmpleado() {
    ...
    $('#campo-minutos-trabajados-relicario').text('');

    $('#campo-minutos-extras-relicario').text('');
    ...
    $('#total-entradas-tempranas-relicario').text('0');

    $('#total-salidas-tardias-relicario').text('0');

    $('#total-salidas-tempranas-relicario').text('0');

    $('#total-olvidos-checador-relicario').text('0');

    $('#total-retardos-relicario').text('0');

    $('#total-inasistencias-relicario').text('0');

    $('#total-comida-relicario').text('0');
