...
function crearHistorialInasistenciasRelicario(empleado) {
...
function crearHistorialRetardosRelicario(empleado) {
    ...
    calcularDescuentoRetardosRelicario(empleado);
...
function calcularDescuentoRetardosRelicario(empleado) {
