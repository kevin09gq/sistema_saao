...
// Generar nombre del archivo con formato: NOMBRE_SEMANA_DEPARTAMENTO_40LBS_AÑO (en mayúsculas)
...
if (empty($departamento)) {
    $filename = 'NOMBRE_SEM_' . $semana . '_40LBS_' . $año . '.pdf';
} else {
    $filename = 'NOMBRE_SEM_' . $semana . '_' . strtoupper($departamento) . '_40LBS_' . $año . '.pdf';
}
