<!-- Modal para generar ticket manual -->
            ...
            <div class="col-md-6">
              ...
              <div class="row g-2 mb-2">
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.01" class="form-control calculo-extra" name="sueldo_extra" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Bono Antigüedad</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="bono_antiguedad" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Actividades Especiales</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="actividades_especiales" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Puesto</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="bono_puesto" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
              </div>
