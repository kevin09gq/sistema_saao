...
<head>
    ...
    <title>Historial Nómina 10LBS</title>
    <?php
...
<body>
    ...
    <div class="container container-tabla-nomina-10lbs mt-5">
        ...
        <div class="header-tabla-10lbs">
            <div class="header-titulo-semana">
                <div class="historial-title-container">
                    ...
                    <h3 class="m-0">Historial de Nóminas - 10 LBS</h3>
                </div>
            </div>

            <div class="header-controls-10lbs">
                <a href="../../views/nomina_10lbs.php" class="btn-historial-action">
        ...
        <div class="controles-tabla-10lbs">
            <div class="filtros-container-10lbs">
                <!-- Selector de Año -->
                <select class="filtro-departamento-10lbs" id="filtro-anio" aria-label="Filtrar por año">
                  
                </select>

                <!-- Campo de Búsqueda -->
                <div class="busqueda-container-10lbs">
                    <i class="bi bi-search"></i>
                    <input type="text" class="campo-busqueda-10lbs" placeholder="Buscar por semana..." id="buscar-semana">
