...
<body class="bg-body-tertiary">
    ...
    <main class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col">
                <h2 class="fw-bold text-dark"><i class="bi bi-clock-history me-2"></i>Historial de PTU</h2>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <!-- Botón a la derecha -->
            <div>
                <a href="utilidad.php" class="btn btn-primary shadow-sm fw-bold">
                    <i class="bi bi-plus-circle me-2"></i>Nuevo PTU
                </a>
            </div>
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="text-center py-3 text-secondary text-uppercase fs-xs">Total PTU</th>
                        ...
                        <tbody class="border-top-0" id="cuerpo_tabla_historial">
    ...
    <?php require_once __DIR__ . '/modal_historial/modal_detalles_historial.php';  ?>
    ...
    * ==============================================================
    ...
    <!-- Script personalizado para manejar el historial -->
