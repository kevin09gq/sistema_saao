<!-- Modal Detalles de modal_detalles_utilidad -->
<div class="modal fade" id="modal_detalles_utilidad" tabindex="-1" aria-labelledby="modal_detalles_label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold" id="modal_detalles_label">
                    <i class="bi bi-info-circle-fill text-primary me-2"></i>Detalles del PTU - <span id="span_anio_detalle">2024</span>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover align-middle border">
                        ...
                        <tbody id="cuerpo_tabla_detalles_ptu">
