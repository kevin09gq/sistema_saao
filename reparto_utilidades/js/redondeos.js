...
$(document).on('change', '.checkbox_empleado_redondeos', function (e) {
    ...
    if (empleado !== -1) {
        ...
        // CALCULAR EL NETO A PAGAR CON REDONDEO
        json.empleados[empleado].neto_pagar_redondeado = calcular_neto_pagar_redondeo(json.empleados[empleado].neto_pagar, json.empleados[empleado].redondeo);
    }
