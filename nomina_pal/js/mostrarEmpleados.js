...
function llenarTablaNomina() {
    ...
    let textoBusqueda = $('#busqueda-nomina-palmilla').val().trim().toUpperCase();
    ...
    jsonNominaPalmilla.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#tabla-nomina-body-palmilla').append(`
    ...
    let deptoSeleccionado = jsonNominaPalmilla.departamentos.find(d => d.id_departamento == idDepartamento);
...
function calcularTotalesPorColumna() {
    ...
    $('#tabla-nomina-foot-palmilla').empty();
    ...
    $('#tabla-nomina-foot-palmilla').append(`
        <tr>
