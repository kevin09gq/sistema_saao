...
function crearHistorialInasistenciasPalmilla(empleado) {
...
function crearHistorialRetardosPalmilla(empleado) {
    ...
    calcularDescuentoRetardosPalmilla(empleado);
...
function calcularDescuentoRetardosPalmilla(empleado) {
