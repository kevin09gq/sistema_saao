...
function establecerEventosEntradasTempranas(empleado) {
    ...
    let departamentoEmpleado = jsonNominaPalmilla.departamentos.find(function (departamento) {
    ...
    if (departamentoEmpleado) {
        ...
        if (departamentoEmpleado.tipo_horario == 1) {
            ...
            tipoHorario = jsonNominaPalmilla.horarioRancho;
...
function establecerEventosMarcajes(empleado) {
    ...
    if (departamentoEmpleado.tipo_horario == 1) {
        ...
        horarioEmpleado = jsonNominaPalmilla.horarioRancho;
