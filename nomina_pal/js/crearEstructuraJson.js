...
$(document).ready(function () {
    ...
    guardarConfiguracionPalmilla();

    // Limpiar la nómina y regresar a la vista de datos
    limpiarNominaPalmilla();
...
function obtenerInfoDepartamento(jsonNominaPalmilla) {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            respuesta.departamentos.forEach(depto => {
                ...
                // Agregar cada departamento al jsonNominaPalmilla 
            ...
            // Cambiar de vista a la configuración de valores económicos del palmilla
...
// Y GUARDARLO EN EL JSON DE LA NOMINA PALMILLA
//===============================================================
...
function obtenerHorarioRancho() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonNominaPalmilla.horarioRancho = respuesta.horario_jornalero;


            console.log(
                "Horario Rancho:",
                jsonNominaPalmilla.horarioRancho
            );
...
function cargarConfiguracionHorarios() {
    ...
    if (!jsonNominaPalmilla || jsonNominaPalmilla.departamentos.length === 0) {
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input
                            class="form-check-input horario-palmilla"
                            type="radio"
...
function guardarConfiguracionPalmilla() {

    // Evento del botón para continuar al procesamiento de la nómina
    $("#btn_config_avanzar_palmilla").click(function () {

        // Obtener los valores económicos
        var precioPasaje = parseFloat($("#precio_pasaje_palmilla").val()) || 0;
        var pagoTardeada = parseFloat($("#pago_tardeada_palmilla").val()) || 0;
        var pagoComida = parseFloat($("#pago_comida_palmilla").val()) || 0;
        ...
        obtenerEmpleados(jsonNominaPalmilla);
...
function obtenerEmpleados(jsonNominaPalmilla) {
