...
function establerDataModal(empleado) {
    ...
    $('#modal-10lbs input').prop('readonly', true);
    $('#modal-10lbs input, #modal-10lbs textarea').prop('readonly', true);
    $('#modal-10lbs select').prop('disabled', true);
...
function establecerSueldoACobrar(empleado) {
    if (!empleado) return;
    const $input = $('#mod-sueldo-a-cobrar-10lbs');
