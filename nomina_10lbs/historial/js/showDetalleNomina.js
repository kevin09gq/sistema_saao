$(document).ready(function () {
    ...
    window.location.href = '../views/historial_10lbs.php'; // Redirige a la página de historial al hacer clic en el botón
});
});
...
// FUNCION PARA OBTENER LA NOMINA DE 10 LIBRAS DE ACUERDO LA ID OBTENIDO DE LA URL
function obtenerDetalleNomina() {
    ...
    $.ajax({
        ...
        success: function (response) {
            const nominaString = response.nomina[0].nomina_10lbs;
