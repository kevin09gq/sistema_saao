...
function guardarNomina() {
    ...
    $('#btn_guardar_nomina_10lbs').click(function (e) {
        e.preventDefault();
        ...
        const totales = calcularTotalesNomina(jsonNomina10lbs);
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        nomina_10lbs: JSON.stringify(jsonNomina10lbs),
                        anio: jsonNomina10lbs.anio,
