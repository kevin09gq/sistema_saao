...
function abrirModalExportarExcel() {
    $(document).on('click', '#btn_export_excel', function (e) {
        ...
        poblarOpcionesExportar(jsonNomina10lbs);
...
function exportarPorDepartamento() {
    ...
    $(document).on('click', '.btn-export-departamento-css, .btn-export-departamento-sss', async function (e) {
        ...
        // Validar que jsonNomina10lbs exista
        if (!jsonNomina10lbs) {
        ...
        // Nueva estructura: id_empresa está en el nivel del departamento, no en color_reporte
        const idEmpresa = deptoInfo ? deptoInfo.id_empresa : 1;
...
function nominaCompleta() {
    ...
    $("#btn-export-nomina-completa").click(async function (e) {
        ...
        // Enviar el jsonNomina10lbs al servidor PHP mediante POST
        $.ajax({
...
function reporteNominaPdf() {
    $("#btn_export_pdf_reporte").click(async function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                numero_semana: jsonNomina10lbs.numero_semana || '',
                fecha_cierre: jsonNomina10lbs.fecha_cierre || '',
                fecha_inicio: jsonNomina10lbs.fecha_inicio || '',
                periodo_nomina: jsonNomina10lbs.periodo_nomina || '',
                jsonNomina: JSON.stringify(jsonNomina10lbs)
            },
            xhrFields: {
                responseType: 'blob'
