        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_seleccion_tickets_label">
                    <i class="bi bi-person-check"></i> Seleccionar Empleados para Tickets (10 Libras)
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-secondary" id="btn_generar_tickets_nombre_seleccionados" disabled>
