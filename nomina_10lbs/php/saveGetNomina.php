...
function guardarNomina($data, $conexion) {
    ...
    $query = "SELECT * FROM nomina_10lbs WHERE numero_semana = ? AND anio = ?";
    ...
    if ($result->num_rows > 0) {
        if ($actualizar) {
            ...
            $updateQuery = "UPDATE nomina_10lbs SET nomina_10lbs = ? WHERE id_empresa = ? AND numero_semana = ? AND anio = ?";
        ...
        $insertQuery = "INSERT INTO nomina_10lbs (id_empresa, numero_semana, anio, nomina_10lbs) VALUES (?, ?, ?, ?)";
