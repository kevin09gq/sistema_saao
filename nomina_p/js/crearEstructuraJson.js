...
function crearEstructuraJson() {
    ...
    $('#btn-continuar').click(function (e) {
        ...
        obtenerInfoDepartamento(jsonNominaPilar);
        ;
    });
...
function obtenerInfoDepartamento(jsonNominaPilar) {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            respuesta.departamentos.forEach(depto => {
                ...
                // Agregar cada departamento al jsonNominaPilar 
                jsonNominaPilar.departamentos.push({
            ...
            // Cambiar de vista a la configuración de valores económicos del pilar
...
function obtenerHorarioRancho() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonNominaPilar.horarioRancho = respuesta.horario_jornalero;


            console.log(
                "Horario Rancho:",
                jsonNominaPilar.horarioRancho
            );
...
function cargarConfiguracionHorarios() {
    ...
    if (!jsonNominaPilar || jsonNominaPilar.departamentos.length === 0) {
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input
                            class="form-check-input horario-pilar"
                            type="radio"
...
function guardarConfiguracionPilar() {

    // Evento del botón para continuar al procesamiento de la nómina
    $("#btn_config_avanzar_pilar").click(function () {

        // Obtener los valores económicos
        var precioPasaje = parseFloat($("#precio_pasaje_pilar").val()) || 0;
        var pagoTardeada = parseFloat($("#pago_tardeada_pilar").val()) || 0;
        var pagoComida = parseFloat($("#pago_comida_pilar").val()) || 0;

        // Guardar los valores en el JSON principal
        jsonNominaPilar.precio_pasaje = precioPasaje;
        jsonNominaPilar.pago_tardeada = pagoTardeada;
        jsonNominaPilar.pago_comida = pagoComida;
        ...
        obtenerEmpleados(jsonNominaPilar);
...
function obtenerEmpleados(jsonNominaPilar) {
