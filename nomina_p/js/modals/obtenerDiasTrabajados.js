...
function calcularPagoComidaEmpleado(empleado) {
    ...
    let pagoComida = parseFloat(jsonNominaPilar.pago_comida) || 0;
...
function calcularPagoPasajeEmpleado(empleado) {
    ...
    let precioPasaje = parseFloat(jsonNominaPilar.precio_pasaje) || 0;
...
function calcularTardeadaEmpleado(empleado) {
    ...
    if (
        ...
        jsonNominaPilar.horarioRancho.length === 0
    ) {
    ...
    empleado.registros.forEach(function(registro) {
        ...
        let horarioDia = jsonNominaPilar.horarioRancho.find(function(horario) {
    ...
    let pagoTardeada =
        parseFloat(jsonNominaPilar.pago_tardeada) || 0;
