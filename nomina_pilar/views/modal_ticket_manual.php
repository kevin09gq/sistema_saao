<!-- Modal para generar ticket manual de nómina relicario -->
<div class="modal fade" id="modalTicketManualRelicario" tabindex="-1" aria-labelledby="modalTicketManualRelicarioLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="formTicketManual">
        <div class="modal-header">
          <h5 class="modal-title" id="modalTicketManualRelicarioLabel"><i class="bi bi-receipt"></i> Generar Ticket Manual</h5>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row g-2 mb-2">
                ...
                <div class="col-md-4">
                  ...
                  <input type="number" step="0.01" class="form-control calculo-extra" name="pasaje" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
                <div class="col-md-4">
                  <label class="form-label">Comida</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="comida" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
              </div>
              ...
              <div class="row g-2 mb-2">
                <div class="col-md-12">
                  ...
                  <input type="number" step="0.01" class="form-control calculo-extra" name="tardeada" placeholder="0.00" onchange="calcularTotalExtra()">
                </div>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="row g-2 mb-2">
                ...
                <!-- Espacio eliminado para evitar huecos visuales -->
              </div>
