...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="header-historial">
            <h2><i class="bi bi-clock-history me-2"></i> Historial de Cortes de Rejas (Pilar)</h2>
    ...
    <script src="../js/historial/historial_pilar.js"></script>
</body>
</html>
