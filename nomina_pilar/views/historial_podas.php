...
<head>
    ...
    <title>Historial Podas - Pilar</title>
    ...
    <style>
        /* Selector de tipo de nómina (Corte/Poda) */
        .nomina-selector {
            display: flex;
            gap: 15px;
            margin-bottom: 25px;
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="header-historial">
            <h2><i class="bi bi-clock-history me-2"></i> Historial de Nóminas (Pilar)</h2>
            <a href="nomina_pilar.php" class="btn btn-light btn-sm text-success fw-bold">
            ...
            <div class="col-12 mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 bg-white p-2 rounded-3 shadow-sm border">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-success btn-sm fw-bold shadow-sm" type="button" onclick="exportarExcel()">
            ...
            <div class="modal-content" style="border: none; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                <div class="modal-header modal-detalles-header">
                    <h5 class="modal-title modal-detalles-title" id="modalDetallePodaLabel">
                        <i class="bi bi-scissors me-2" id="det_tipo_icon"></i>
                        <span id="det_tipo_text">Detalles de Poda</span> - <span id="det_empleado" class="text-warning"></span>
                    </h5>
