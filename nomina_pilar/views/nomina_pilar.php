        ...
        <div class="navbar-nomina_pilar">
            ...
            <form id="form_excel_raya" enctype="multipart/form-data" class="form-nomina-inline-pilar">
                <div>
                    ...
                    <input type="file" id="archivo_excel_lista_raya_pilar" name="archivo_excel_lista_raya_pilar"
                ...
                <div>
                    ...
                    <input type="file" id="archivo_excel_biometrico_pilar" name="archivo_excel_biometrico_pilar"
                        accept=".xls,.xlsx" required>
                </div>
                <div>
                        ...
                        <div class="col-md-5 bg-light p-4 border-end">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="precio_pasaje_pilar" class="form-control form-control-sm"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" id="pago_tardeada_pilar" class="form-control form-control-sm"
                                        placeholder="0.00" step="0.01" min="0">
                                </div>
                            </div>
