...
function llenarSelectoresDelModal() {
    ...
    $.each(jsonNominaPilar.departamentos, function (indice, departamento) {
...
function mostrarInformacionDelEmpleado(claveBuscada) {
    ...
    let departamentoActual = jsonNominaPilar.departamentos.find(dept => 
...
function verificarCompatibilidadHorarios() {
    ...
    let departamentoObjetivo = jsonNominaPilar.departamentos.find(d => d.id_departamento == idDepartamentoDestino);
...
function moverEmpleadoNuevoDepartamento() {
    ...
    let departamentoDestino = jsonNominaPilar.departamentos.find(d => d.id_departamento == idDestino);
