...
function llenarTablaNomina() {
    ...
    let textoBusqueda = $('#busqueda-nomina-pilar').val().trim().toUpperCase();
    ...
    jsonNominaPilar.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#tabla-nomina-body-pilar').append(`
    ...
    let deptoSeleccionado = jsonNominaPilar.departamentos.find(d => d.id_departamento == idDepartamento);
...
function calcularTotalesPorColumna() {
    ...
    $('#tabla-nomina-foot-pilar').append(`
        <tr>
