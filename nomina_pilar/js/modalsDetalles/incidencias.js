...
function crearHistorialInasistenciasPilar(empleado) {
...
function crearHistorialRetardosPilar(empleado) {
    ...
    calcularDescuentoRetardosPilar(empleado);
...
function calcularDescuentoRetardosPilar(empleado) {
