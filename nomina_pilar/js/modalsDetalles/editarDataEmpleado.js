...
function limpiarModalDetallesNominaEmpleado() {
    ...
    $('#campo-minutos-trabajados-pilar').text('');

    $('#campo-minutos-extras-pilar').text('');
    ...
    $('#total-entradas-tempranas-pilar').text('0');

    $('#total-salidas-tardias-pilar').text('0');

    $('#total-salidas-tempranas-pilar').text('0');

    $('#total-olvidos-checador-pilar').text('0');

    $('#total-retardos-pilar').text('0');

    $('#total-inasistencias-pilar').text('0');

    $('#total-comida-pilar').text('0');
