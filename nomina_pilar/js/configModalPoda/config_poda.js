 ...
 * @param {Object} json El jsonNominaPilar completo de nómina del Relicario
...
$(document).on('change', '#dia_semana_poda', function (e) {
    ...
    let fechas = obtenerRangoFechas(
        jsonNominaPilar.fecha_inicio,
        jsonNominaPilar.fecha_cierre,
        false
    );
...
function guardar_poda(nombre_empleado, fecha_poda, arboles_podados, pago_arbol) {
    ...
    let nuevoMovimiento = {
        'id': obtenerSiguienteIdPoda(jsonNominaPilar),
        'concepto': 'PODA',
        'fecha': fecha_poda,
