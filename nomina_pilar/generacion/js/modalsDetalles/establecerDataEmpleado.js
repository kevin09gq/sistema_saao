...
function establecerDataEmpleado(empleado) {
 ...
 // Establecer Dias Trabajados
    ...
    establecerEventosEntradasTempranas(empleado, jsonNominaPilar);
    establecerEventosSalidasTardias(empleado, jsonNominaPilar);
    establecerEventosSalidasTempranas(empleado, jsonNominaPilar);
    establecerEventosRetardos(empleado, jsonNominaPilar);
    establecerEventosAusentismos(empleado, jsonNominaPilar);
    establecerEventosComidaExtra(empleado, jsonNominaPilar);
    establecerEventosMarcajes(empleado, jsonNominaPilar);
...
function ocultarComponentesModalDetalles(empleado) {
    ...
    let departamentoEmpleado = jsonNominaPilar.departamentos.find(function (departamento) {
