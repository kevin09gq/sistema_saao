...
function abrirModalActualizarValores() {
    ...
    $('#btn_actualizar_valores_pilar').click(function () {
...
function establecerValores() {
    // Establecer los valores en los campos del modal
    $('#precio_pasaje_actualizar').val(jsonNominaPilar.precio_pasaje);
    $('#pago_comida_actualizar').val(jsonNominaPilar.pago_comida);
    $('#pago_tardeada_actualizar').val(jsonNominaPilar.pago_tardeada);
}
...
function guardarValoresActualizados() {
    $("#btn_guardar_valores").click(function (e) {
        ...
        // Actualizar en el JsonNominaPilar
