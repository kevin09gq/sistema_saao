...
<head>
    ...
    <title>Historial Nomina Pilar</title>
...
<body class="bg-secondary-subtle">
    ...
    <div class="container-tabla-nomina-pilar" id="tabla-nomina-responsive">
        ...
        <div class="controles-tabla-pilar">
            <div class="filtros-container-pilar">
                <select class="filtro-departamento-pilar" id="detalle-filtro-departamento">
                    <!-- Se poblará dinámicamente -->
                </select>

                <div class="busqueda-container-pilar" id="detalle-busqueda-container">
                    <i class="bi bi-search"></i>
                    <input type="text" class="campo-busqueda-pilar" placeholder="Buscar..." id="detalle-busqueda-nomina-pilar">
        ...
        <div id="tabla-nomina-container-pilar" class="tabla-nomina-container-pilar">
            <div class="table-responsive-pilar">
                <table class="table-nomina-pilar" id="tabla-nomina">
                    ...
                    <tbody id="detalle-tabla-nomina-body-pilar">
                        <!-- Filas de la tabla se generarán dinámicamente -->



                    </tbody>
                    <tfoot id="detalle-tabla-nomina-foot-pilar">
