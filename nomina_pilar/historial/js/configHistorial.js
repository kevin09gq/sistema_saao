...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#detalle-tabla-nomina-body-pilar tr', function (e) {
...
function regresarHistorialPilar() {

    $('#btnRegresar').on('click', function () {
        // Redirigir a la vista historial_pilar
        window.location.href = "historial_pilar.php";

        // Limpiar el localStorage
        localStorage.removeItem('id_nomina_pilar');
