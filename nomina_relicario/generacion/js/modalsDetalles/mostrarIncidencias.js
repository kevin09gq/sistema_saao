...
//==========================================================
function obtenerDatosNominaRelicario(dataNomina = null) {
    ...
    if (typeof jsonNominaRelicario !== 'undefined' && jsonNominaRelicario && jsonNominaRelicario.departamentos) {
        return jsonNominaRelicario;
    }
    if (typeof jsonHistorialRelicario !== 'undefined' && jsonHistorialRelicario && jsonHistorialRelicario.departamentos) {
        return jsonHistorialRelicario;
    }
    return null;
}
...
//==========================================================
function obtenerHorarioEmpleadoRelicario(empleado, dataNomina = null) {
    if (!empleado) return [];
    let data = obtenerDatosNominaRelicario(dataNomina);
...
//==========================================================
function obtenerDepartamentoEmpleadoRelicario(empleado, dataNomina = null) {
...
function establecerEventosOlvidosBiometrico(data) {
    ...
    // Limpiar contenedor
    $("#olvidos-checador-relicario").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#olvidos-checador-relicario").html(`
            <div class="text-muted text-center">
                No hubo olvidos.
            </div>
        `);

        $("#total-olvidos-checador-relicario").text(0);
    ...
    registros.forEach((registro) => {
        ...
        if (registro.entrada === "" || registro.salida === "") {
            ...
            $("#olvidos-checador-relicario").append(`
    ...
    // Mostrar total
    $("#total-olvidos-checador-relicario").text(totalOlvidos);
...
function establecerEventosEntradasTempranas(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#entradas-tempranas-relicario").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#entradas-tempranas-relicario").html(`
            <div class="text-muted text-center">
                No hubo entradas tempranas.
            </div>
        `);

        $("#total-entradas-tempranas-relicario").text("00:00");

        return;
    }

    // obtener el horario según el tipo de horario del departamento
    let tipoHorario = obtenerHorarioEmpleadoRelicario(empleado, dataNomina);
    ...
    registros.forEach(function (registro) {
        ...
        if (entradaEmpleado <= limiteEntradaTemprana) {
            ...
            $("#entradas-tempranas-relicario").append(`
                <div class="small py-1 border-bottom">
    ...
    $("#total-entradas-tempranas-relicario")
...
function establecerEventosSalidasTardias(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#salidas-tardias-relicario").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tardias-relicario").html(`
            <div class="text-muted text-center">
                No hubo salidas tardías.
            </div>
        `);

        $("#total-salidas-tardias-relicario").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (salidaEmpleado >= limiteSalidaTardia) {
            ...
            $("#salidas-tardias-relicario").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tardias-relicario")
...
function establecerEventosSalidasTempranas(empleado, dataNomina = null) {
    ...
    // Limpiar contenedor
    $("#salidas-tempranas-relicario").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tempranas-relicario").html(`
            <div class="text-muted text-center">
        ...
        $("#total-salidas-tempranas-relicario").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (minutosAntes >= 5) {
            ...
            $("#salidas-tempranas-relicario").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tempranas-relicario")
...
function establecerEventosRetardos(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#retardos-relicario").html(`
            <div class="text-muted text-center">
                No hubo retardos.
            </div>
        `);

        $("#total-retardos-relicario").text("00:00");
...
function establecerEventosAusentismos(empleado, dataNomina = null) {
    ...
    // limpiar contenedor
    $("#inasistencias-content-relicario").empty();
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#inasistencias-content-relicario").html(`
            <div class="text-success text-center">
                Sin ausentismos.
            </div>
        `);

        $("#total-inasistencias-relicario").text(0);
    ...
    registros.forEach(function (registro) {
        ...
        if (
            ...
            $("#inasistencias-content-relicario").append(`
                <div class="small py-1 border-bottom">
...
function establecerEventosComidaExtra(empleado, dataNomina = null) {
    ...
    if (registros.length == 0) {
        ...
        $("#comida-relicario").html(`
            <div class="text-muted text-center">
                Sin comida extra.
            </div>
        `);

        $("#total-comida-relicario").text("00:00");

        return;
    }

    // validar que el empleado tenga horario oficial
    let horarioOficial = obtenerHorarioEmpleadoRelicario(empleado, dataNomina) || [];
...
function establecerEventosMarcajes(empleado, dataNomina = null) {
    ...
    if (registros.length == 0) {
        ...
        $("#marcajes-relicario").html(`
            <div class="text-muted text-center">
                Sin marcajes excedentes.
            </div>
        `);

        $("#total-marcajes-relicario").text(0);

        return;
    }

    // buscar el departamento del empleado
    let departamentoEmpleado = obtenerDepartamentoEmpleadoRelicario(empleado, dataNomina);
    ...
    let horarioEmpleado = obtenerHorarioEmpleadoRelicario(empleado, dataNomina);
