...
function establecerDataEmpleado(empleado) {
    ...
    establecerEventosEntradasTempranas(empleado, jsonNominaRelicario);
    establecerEventosSalidasTardias(empleado, jsonNominaRelicario);
    establecerEventosSalidasTempranas(empleado, jsonNominaRelicario);
    establecerEventosRetardos(empleado, jsonNominaRelicario);
    establecerEventosAusentismos(empleado, jsonNominaRelicario);
    establecerEventosComidaExtra(empleado, jsonNominaRelicario);
    establecerEventosMarcajes(empleado, jsonNominaRelicario);
