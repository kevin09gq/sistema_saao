...
function cargarEmpleadosParaTickets() {
    ...
    const nominaData = window.jsonNominaRelicario;
    ...
    const listaHtml = `
        <div class="list-group">
            ${empleados.map(empleado => {
                ...
                // Departamentos específicos con colores únicos (adaptados para Relicario)
