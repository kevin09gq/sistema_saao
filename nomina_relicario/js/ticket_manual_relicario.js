// ticket_manual_relicario.js - Lógica para ticket manual en nómina relicario
...
$(document).ready(function() {
    ...
    // Pero en Relicario el botón gris de ticket manual ahora abre la selección. 
    ...
    $('#formTicketManualRelicario').on('submit', function(e) {
        e.preventDefault();
    ...
    const setupAutocomplete = (inputId, suggestionId, field) => {
        $(`#${inputId}`).on('input', function() {
            ...
            $.ajax({
                url: rutaRaiz + '/nomina_relicario/php/buscar_empleado.php',
                method: 'GET',
    ...
    function llenarCamposManual(emp) {
        const form = $('#formTicketManualRelicario');
