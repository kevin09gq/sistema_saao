 ...
 * @param {Object} json El jsonNominaRelicario completo de nómina del Relicario
...
$(document).on('change', '#dia_semana_poda', function (e) {
    ...
    let fechas = obtenerRangoFechas(
        jsonNominaRelicario.fecha_inicio,
        jsonNominaRelicario.fecha_cierre,
        false
    );
...
function guardar_poda(nombre_empleado, fecha_poda, arboles_podados, pago_arbol) {
    ...
    let nuevoMovimiento = {
        'id': obtenerSiguienteIdPoda(jsonNominaRelicario),
        'concepto': 'PODA',
        'fecha': fecha_poda,
