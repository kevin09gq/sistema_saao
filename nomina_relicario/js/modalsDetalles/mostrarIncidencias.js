...
function establecerEventosEntradasTempranas(empleado) {
    ...
    if (departamentoEmpleado) {
        ...
        if (departamentoEmpleado.tipo_horario == 1) {
            ...
            // horario oficial propio del empleado
            tipoHorario = empleado.horario_oficial;
...
function establecerEventosMarcajes(empleado) {
    ...
    if (departamentoEmpleado.tipo_horario == 1) {
        ...
        // tipo 1 utiliza el horario oficial del empleado
        horarioEmpleado = empleado.horario_oficial;
