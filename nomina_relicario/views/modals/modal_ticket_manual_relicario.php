<!-- Modal para generar ticket manual - Relicario -->
<div class="modal fade" id="modalTicketManual" tabindex="-1" aria-labelledby="modalTicketManualLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="formTicketManual">
        <div class="modal-header">
          <h5 class="modal-title" id="modalTicketManualLabel"><i class="bi bi-receipt"></i> Generar Ticket Manual (Relicario)</h5>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row g-2 mb-2">
                <div class="col-md-4">
                  ...
                  <input type="number" step="0.01" class="form-control" name="sueldo_base" placeholder="0.00">
                </div>
                <div class="col-md-4">
                  <label class="form-label">Incentivo</label>
                  <input type="number" step="0.01" class="form-control" name="incentivo" placeholder="0.00">
                </div>
              </div>
              ...
              <div class="row g-2 mb-2">
                <div class="col-md-3">
                  ...
                  <input type="number" step="0.01" class="form-control calculo-extra" name="sueldo_extra" placeholder="0.00">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Bono Antigüedad</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="bono_antiguedad" placeholder="0.00">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Actividades Especiales</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="actividades_especiales" placeholder="0.00">
                </div>
                <div class="col-md-3">
                  <label class="form-label">Puesto</label>
                  <input type="number" step="0.01" class="form-control calculo-extra" name="bono_puesto" placeholder="0.00">
                </div>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="row g-2 mb-2">
                ...
                <div class="col-md-6">
                  <label class="form-label">F.A/GAFET/COFIA ($)</label>
                  <input type="number" step="0.01" class="form-control" name="fa_gafet_cofia" placeholder="0.00">
                </div>
                <div class="col-md-6">
                  <label class="form-label">Descuento por Inasistencias ($)</label>
                  <input type="number" step="0.01" class="form-control" name="inasistencias_descuento" placeholder="0.00">
                </div>
              </div>
