...
// Generar nombre del archivo con formato: NOMBRE_SEMANA_DEPARTAMENTO_RANCHO_AÑO (en mayúsculas)
...
if (empty($departamento)) {
    $filename = 'NOMBRE_SEM_' . $semana . '_RANCHO RELICARIO_' . $año . '.pdf';
} else {
    $filename = 'NOMBRE_SEM_' . $semana . '_' . strtoupper($departamento) . '_RANCHO RELICARIO_' . $año . '.pdf';
}
