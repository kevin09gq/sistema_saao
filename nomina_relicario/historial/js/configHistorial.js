...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#detalle-tabla-nomina-body-relicario tr', function (e) {
...
function regresarHistorialRelicario() {

    $('#btnRegresar').on('click', function () {
        // Redirigir a la vista historial_relicario
        window.location.href = "historial_relicario.php";

        // Limpiar el localStorage
        localStorage.removeItem('id_nomina_relicario');
