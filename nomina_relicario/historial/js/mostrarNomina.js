...
function obtenerIdNomina() {
    ...
    return parametros.get('id_nomina_relicario');
...
function obtenerNomina() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonHistorialRelicario = nomina.nomina_relicario;
...
function llenarTablaNominaHistorial() {
    ...
    $('#detalle-tabla-nomina-body-relicario').empty();

    // Obtener el departamento seleccionado
    let filtro = $('#detalle-filtro-departamento').val();

    // Obtener el texto escrito en el buscador
    let textoBusqueda = $('#detalle-busqueda-nomina-relicario').val().trim().toUpperCase();
    ...
    jsonHistorialRelicario.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#detalle-tabla-nomina-body-relicario').append(`
    ...
    let deptoSeleccionado = jsonHistorialRelicario.departamentos.find(d => d.id_departamento == idDepartamento);
    ...
    actualizarCabeceraNomina(jsonHistorialRelicario)
...
function calcularTotalesPorColumna() {
    ...
    $('#detalle-tabla-nomina-foot-relicario').empty();
    ...
    $('#detalle-tabla-nomina-foot-relicario').append(`
        <tr>
