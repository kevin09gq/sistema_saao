...
function establecerDataEmpleado(empleado) {
    ...
    establecerEventosEntradasTempranas(empleado, jsonHistorialRelicario);
    establecerEventosSalidasTardias(empleado, jsonHistorialRelicario);
    establecerEventosSalidasTempranas(empleado, jsonHistorialRelicario);
    establecerEventosRetardos(empleado, jsonHistorialRelicario);
    establecerEventosAusentismos(empleado, jsonHistorialRelicario);
    establecerEventosComidaExtra(empleado, jsonHistorialRelicario);
    establecerEventosMarcajes(empleado, jsonHistorialRelicario);
...
function ocultarComponentesModalDetalles(empleado) {
    ...
    let departamentoEmpleado = jsonHistorialRelicario.departamentos.find(function (departamento) {
