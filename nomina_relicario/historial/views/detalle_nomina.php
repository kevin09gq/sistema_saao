...
<head>
    ...
    <title>Historial Nomina Relicario</title>
...
<body class="bg-secondary-subtle">
    ...
    <div class="container-tabla-nomina-relicario" id="tabla-nomina-responsive">
        ...
        <div class="controles-tabla-relicario">
            <div class="filtros-container-relicario">
                <select class="filtro-departamento-relicario" id="detalle-filtro-departamento">
                    <!-- Se poblará dinámicamente -->
                </select>

                <div class="busqueda-container-relicario" id="detalle-busqueda-container">
                    <i class="bi bi-search"></i>
                    <input type="text" class="campo-busqueda-relicario" placeholder="Buscar..." id="detalle-busqueda-nomina-relicario">
        ...
        <div id="tabla-nomina-container-relicario" class="tabla-nomina-container-relicario">
            <div class="table-responsive-relicario">
                <table class="table-nomina-relicario" id="tabla-nomina">
                    ...
                    <tbody id="detalle-tabla-nomina-body-relicario">
                        <!-- Filas de la tabla se generarán dinámicamente -->



                    </tbody>
                    <tfoot id="detalle-tabla-nomina-foot-relicario">
