...
$tmp_nombre = 'SEM ' . $jsonNomina['numero_semana'] . ' - ' . date('Y') . ' RANCHO LA PALMILLA NOMINAS - CORTE DE LIMON - ' . date('Y-m-d_H-i-s');
...
$spreadsheet->getProperties()
    ...
    ->setDescription("Reporte de Corte Rancho LA PALMILLA S.I.G. SAAO")
