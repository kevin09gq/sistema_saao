...
function crearHoja($spreadsheet, $titulo2, $filtroEmpleados, $nombreHoja) {
    ...
    // Formatear título 1 - RANCHO LA PALMILLA (Purpura, Negrita, Tamaño 24)
    ...
    $sheet->getStyle('A6:AA6')->getFill()->getStartColor()->setRGB('C9C5C3'); // Rojo
...
$filename = 'SEM ' . str_pad($numero_semana, 2, '0', STR_PAD_LEFT) . ' - ' . $ano . ' RANCHO LA PALMILLA NOMINAS COMPLETAS - ' . date('Y-m-d_H-i-s') . '.xlsx';
