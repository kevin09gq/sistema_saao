...
$sheet->getStyle('A6:AA6')->getFill()->getStartColor()->setRGB('C9C5C3'); // Purpura
...
// Recopilar empleados Jornaleros Base (id_tipo_puesto = 10 o 11 y mostrar = true)
$empleadosJornaleros = [];
...
$filename = 'Nomina_Jornalero_Base_Pilar_' . date('Y-m-d_H-i-s') . '.xlsx';
