...
function guardarNominaPalmilla($data, $conexion)
{
    ...
    if ($result->num_rows > 0) {
        if ($actualizar) {
            ...
            $updateQuery = "UPDATE nomina_palmilla SET nomina_palmilla = ? WHERE id_empresa = ? AND numero_semana = ? AND anio = ?";
        ...
        $insertQuery = "INSERT INTO nomina_palmilla (id_empresa, numero_semana, anio, nomina_palmilla) VALUES (?, ?, ?, ?)";
