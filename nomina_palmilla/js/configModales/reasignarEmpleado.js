...
function llenarSelectoresDelModal() {
    ...
    $.each(jsonNominaPalmilla.departamentos, function (indice, departamento) {
...
function mostrarInformacionDelEmpleado(claveBuscada) {
    ...
    let departamentoActual = jsonNominaPalmilla.departamentos.find(dept => 
...
function verificarCompatibilidadHorarios() {
    ...
    let departamentoObjetivo = jsonNominaPalmilla.departamentos.find(d => d.id_departamento == idDepartamentoDestino);
...
function moverEmpleadoNuevoDepartamento() {
    ...
    let departamentoDestino = jsonNominaPalmilla.departamentos.find(d => d.id_departamento == idDestino);
