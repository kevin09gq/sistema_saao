...
function mostrarDatosTabla(jsonNominaPalmilla, pagina = 1) {
    ...
    empleadosPagina.forEach((empleado, index) => {
        ...
        `;
        $('#tabla-nomina-body-palmilla').append(fila);
    });
    ...
    if (pagina === totalPaginas && todosEmpleados.length > 0) {
        ...
        $('#tabla-nomina-body-palmilla').append(filaTotal);
    }

    // Crear la paginación
    paginarTabla(jsonNominaPalmilla, todosEmpleados.length, pagina, empleadosPorPagina);
}



function paginarTabla(jsonNominaPalmilla, totalEmpleados, paginaActual, empleadosPorPagina) {
    ...
    $('#paginacion-nomina .page-link').on('click', function (e) {
        ...
        mostrarDatosTabla(jsonNominaPalmilla, nuevaPagina);
    });
}
