        ...
        $.ajax({
            ...
            success: function (res) {
                try {
                    ...
                    unirBiometricoConSeleccionados(jsonNominaPalmilla, JsonBiometrico, clavesSeleccionadas);
                    ...
                    clavesSeleccionadas.forEach(obj => {
                        ...
                        // Si es coordinador (id_departamento === 14), recalcular eventos
                        if (parseInt(emp.id_departamento) === 14) {
                        ...
                        else if (parseInt(emp.id_departamento) === 21) {
                            // Verificar si existe horarioRancho
                            if (!jsonNominaPalmilla.horarioRancho || !Array.isArray(jsonNominaPalmilla.horarioRancho)) {
...
function unirBiometricoConSeleccionados(jsonNominaPalmilla, JsonBiometrico, clavesSeleccionadas) {
