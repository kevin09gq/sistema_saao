...
// RECUERDA CAMBIAR container-acceso-palmilla A container-nomina_palmilla
// CUANDO HAYA EMPLEADOS ASEGURADOS
// ============================================

function initComponents() {
    $("#container-nomina_palmilla").attr("hidden", true);
    $("#container-acceso-palmilla").attr("hidden", true);
...
function mostrarConfigValores(bandera) {
    ...
    $("#container-acceso-palmilla").attr("hidden", true);
    $("#config-valores-palmilla").removeAttr("hidden");
...
function asignarValoresConfig(statusRancho = true) {
    $("#btn_config_avanzar_palmilla").click(function (e) {
        e.preventDefault();

        // Obtener los valores de los inputs
        let pasajeVal = $("#precio_pasaje_palmilla").val().trim();
        let tardeadaVal = $("#pago_tardeada_palmilla").val().trim();
        let comidaVal = $("#pago_comida_palmilla").val().trim();
        ...
        if (statusRancho) {
            ...
            //  let jsonFiltrado = filtrarEmpleadosPorDepartamento(jsonNominaPalmilla, 8);
    ...
    $("#btn_limpiar_datos").click(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // $("#container-nomina_palmilla").removeAttr("hidden");
...
function quitarTarjeta() {
    ...
    $(document).on('click', '#btn_delete_tarjeta', function () {
        if (typeof jsonNominaPalmilla === 'undefined' || !jsonNominaPalmilla || !Array.isArray(jsonNominaPalmilla.departamentos)) {
