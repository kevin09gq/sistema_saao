...
function recalcularEventosCoordinador(empleado) {
    ...
    if (!empleado || parseInt(empleado.id_departamento) !== 14) {
        return;
    }
...
function calcularRetardosTodosCoordinadores(jsonNominaPalmilla) {
...
function calcularInasistenciasTodosCoordinadores(jsonNominaPalmilla) {
    // Validar que exista la nómina y sus departamentos
    if (!jsonNominaPalmilla || !Array.isArray(jsonNominaPalmilla.departamentos)) {
        return;
    }
...
function calcularOlvidosTodosCoordinadores(jsonNominaPalmilla) {
    // Validar que exista la nómina y sus departamentos
    if (!jsonNominaPalmilla || !Array.isArray(jsonNominaPalmilla.departamentos)) {
        return;
    }
