//============================================================================
// FUNCION PARA OCULTAR EL CONTENEDOR DE DATOS PARA MOSTRAR 
// EL CONTENEDOR DE CONFIGURACION DE VALORES ECONOMICOS DEL PALMILLA
//============================================================================
...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#tabla-nomina-body-palmilla tr', function (e) {
...
function limpiarNominaPalmilla() {
