...
//==========================================================
function obtenerDatosNominaPalmilla(dataNomina = null) {
    if (dataNomina && dataNomina.departamentos) {
        return dataNomina;
    }
    if (typeof jsonNominaPalmilla !== 'undefined' && jsonNominaPalmilla && jsonNominaPalmilla.departamentos) {
        return jsonNominaPalmilla;
    }
    if (typeof jsonHistorialPalmilla !== 'undefined' && jsonHistorialPalmilla && jsonHistorialPalmilla.departamentos) {
        return jsonHistorialPalmilla;
    }
    return null;
}
...
//==========================================================
function obtenerHorarioEmpleadoPalmilla(empleado, dataNomina = null) {
    if (!empleado) return [];
    let data = obtenerDatosNominaPalmilla(dataNomina);
...
//==========================================================
function obtenerDepartamentoEmpleadoPalmilla(empleado, dataNomina = null) {
...
function establecerEventosOlvidosBiometrico(data) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#olvidos-checador-palmilla").html(`
    ...
    registros.forEach((registro) => {
        ...
        if (registro.entrada === "" || registro.salida === "") {
            ...
            $("#olvidos-checador-palmilla").append(`
    ...
    // Mostrar total
    $("#total-olvidos-checador-palmilla").text(totalOlvidos);
...
function establecerEventosEntradasTempranas(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#entradas-tempranas-palmilla").html(`
            <div class="text-muted text-center">
                No hubo entradas tempranas.
            </div>
        `);

        $("#total-entradas-tempranas-palmilla").text("00:00");

        return;
    }

    // obtener el horario según el tipo de horario del departamento
    let tipoHorario = obtenerHorarioEmpleadoPalmilla(empleado, dataNomina);
    ...
    registros.forEach(function (registro) {
        ...
        if (entradaEmpleado <= limiteEntradaTemprana) {
            ...
            $("#entradas-tempranas-palmilla").append(`
                <div class="small py-1 border-bottom">
    ...
    $("#total-entradas-tempranas-palmilla")
...
function establecerEventosSalidasTardias(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tardias-palmilla").html(`
            <div class="text-muted text-center">
                No hubo salidas tardías.
            </div>
        `);

        $("#total-salidas-tardias-palmilla").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (salidaEmpleado >= limiteSalidaTardia) {
            ...
            $("#salidas-tardias-palmilla").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tardias-palmilla")
...
function establecerEventosSalidasTempranas(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#salidas-tempranas-palmilla").html(`
            <div class="text-muted text-center">
        ...
        $("#total-salidas-tempranas-palmilla").text("00:00");
    ...
    Object.keys(registrosPorDia).forEach(function (fecha) {
        ...
        if (minutosAntes >= 5) {
            ...
            $("#salidas-tempranas-palmilla").append(`
                <div class="small py-1 border-bottom">
    ...
    // Mostrar total acumulado
    $("#total-salidas-tempranas-palmilla")
...
function establecerEventosRetardos(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#retardos-palmilla").html(`
            <div class="text-muted text-center">
                No hubo retardos.
            </div>
        `);

        $("#total-retardos-palmilla").text("00:00");
...
function establecerEventosAusentismos(empleado, dataNomina = null) {
    ...
    if (!registros || registros.length == 0) {
        ...
        $("#inasistencias-content-palmilla").html(`
            <div class="text-success text-center">
                Sin ausentismos.
            </div>
        `);
    ...
    registros.forEach(function (registro) {
        ...
        if (
            ...
            $("#inasistencias-content-palmilla").append(`
                <div class="small py-1 border-bottom">
...
function establecerEventosComidaExtra(empleado, dataNomina = null) {
    ...
    if (registros.length == 0) {
        ...
        $("#comida-palmilla").html(`
            <div class="text-muted text-center">
                Sin comida extra.
            </div>
        `);

        $("#total-comida-palmilla").text("00:00");

        return;
    }

    // validar que el empleado tenga horario oficial
    let horarioOficial = obtenerHorarioEmpleadoPalmilla(empleado, dataNomina) || [];
...
function establecerEventosMarcajes(empleado, dataNomina = null) {
    ...
    let departamentoEmpleado = obtenerDepartamentoEmpleadoPalmilla(empleado, dataNomina);
    ...
    let horarioEmpleado = obtenerHorarioEmpleadoPalmilla(empleado, dataNomina);
