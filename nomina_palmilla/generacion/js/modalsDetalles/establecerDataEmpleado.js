...
function establecerDataEmpleado(empleado) {
    ...
    establecerEventosEntradasTempranas(empleado, jsonNominaPalmilla);
    establecerEventosSalidasTardias(empleado, jsonNominaPalmilla);
    establecerEventosSalidasTempranas(empleado, jsonNominaPalmilla);
    establecerEventosRetardos(empleado, jsonNominaPalmilla);
    establecerEventosAusentismos(empleado, jsonNominaPalmilla);
    establecerEventosComidaExtra(empleado, jsonNominaPalmilla);
    establecerEventosMarcajes(empleado, jsonNominaPalmilla);
