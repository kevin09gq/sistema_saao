...
function calcularPagoComidaEmpleado(empleado) {
    ...
    let pagoComida = parseFloat(jsonNominaPalmilla.pago_comida) || 0;
...
function calcularPagoPasajeEmpleado(empleado) {
    ...
    let precioPasaje = parseFloat(jsonNominaPalmilla.precio_pasaje) || 0;
...
function calcularTardeadaEmpleado(empleado) {
    ...
    if (
        ...
        jsonNominaPalmilla.horarioRancho.length === 0
    ) {
    ...
    empleado.registros.forEach(function(registro) {
        ...
        let horarioDia = jsonNominaPalmilla.horarioRancho.find(function(horario) {
    ...
    let pagoTardeada =
        parseFloat(jsonNominaPalmilla.pago_tardeada) || 0;
