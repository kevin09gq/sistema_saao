...
// FUNCION PARA OBTENER LA INFORMACION DE LOS DEPARTAMENTOS RELACIONADO A LA NOMINA PALMILLA
...
// FUNCIÓN PARA OBTENER LOS EMPLEADOS RELACIONADOS CON LA NÓMINA PALMILLA.
...
function guardarNomina(mysqli $conexion)
{
    ...
    $jsonNomina = $_POST['nomina_palmilla'] ?? '';
    $anio = $_POST['anio'] ?? 0;
    ...
    $sqlCheck = "SELECT id_nomina_palmilla FROM nomina_palmilla 
    ...
    if ($resultadoCheck->num_rows > 0) {
        ...
        $idNomina = $fila['id_nomina_palmilla'];

        $sqlUpdate = "UPDATE nomina_palmilla 
                      SET nomina_palmilla = ?, 
                          total_percepciones = ?, 
                          total_deducciones = ?, 
                          total_neto = ?
                      WHERE id_nomina_palmilla = ?";
        ...
        $sqlInsert = "INSERT INTO nomina_palmilla
                      (id_empresa, anio, numero_semana, nomina_palmilla, total_percepciones, total_deducciones, total_neto)
                      VALUES (?, ?, ?, ?, ?, ?, ?)";
...
function recuperarUltimaNomina(mysqli $conexion)
{
    ...
    $sql = "SELECT id_nomina_palmilla, anio, numero_semana, nomina_palmilla,
                   total_percepciones, total_deducciones, total_neto
            FROM nomina_palmilla
            WHERE id_empresa = ?
            ORDER BY id_nomina_palmilla DESC
            LIMIT 1";
    ...
    $id_nomina = $fila['id_nomina_palmilla'];
    $nomina_raw = $fila['nomina_palmilla'];
    ...
    echo json_encode([
        ...
        "nomina_info" => [
            "id_nomina_palmilla" => $fila['id_nomina_palmilla'],
            "anio" => $fila['anio'],
...
/**
 * NOTA: BORRAR LUEGO
 * Función para guardar tickets de corte (llamada desde guardarNominapalmilla)
 */
