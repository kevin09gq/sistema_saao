    ...
    <div class="container-tabla-nomina-palmilla" id="tabla-nomina-responsive" hidden>
        <div class="header-tabla-palmilla">
            ...
            <div class="header-controls-palmilla">
                <!-- Grupo 1: Servicios -->
                <div class="btn-group-palmilla btn-group-servicios">
                ...
                <div class="btn-group-palmilla btn-group-config">
        ...
        <div id="tabla_poda_container" class="tabla-nomina-container-palmilla-corte" hidden>
            <div class="table-responsive-palmilla-corte">
                <table class="table-nomina-palmilla-corte" id="tabla_poda">
                    <thead>
                        <tr>
                            <th rowspan="2">#</th>
                            <th rowspan="2">NOMBRE</th>
