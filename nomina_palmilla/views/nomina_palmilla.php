...
<body>
        ...
        <div class="navbar-nomina_palmilla">
            ...
            <form id="form_excel_raya" enctype="multipart/form-data" class="form-nomina-inline-palmilla">
                <div>
                    ...
                    <input type="file" id="archivo_excel_lista_raya_palmilla" name="archivo_excel_lista_raya_palmilla"
                ...
                <div>
                    ...
                    <input type="file" id="archivo_excel_biometrico_palmilla" name="archivo_excel_biometrico_palmilla"
                        accept=".xls,.xlsx" required>
                </div>
                <div>
    ...
    <div id="container-acceso-palmilla" hidden>
        ...
        <div class="container mt-4" style="max-width: 600px;">
            ...
            <ul class="nav nav-tabs" id="tabsAccesoPalmilla" role="tablist">
                ...
                <div class="tab-pane fade show active" id="panel-crear-nomina" role="tabpanel"
                    ...
                    <form id="form_crear_nomina_palmilla" class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control" id="semana_nomina_palmilla"
                                name="semana_nomina_palmilla" min="1" max="53" placeholder="Ej. 5" required>
                        </div>
                        <div class="col-md-6">
                            <label for="fecha_inicio_nomina_palmilla" class="form-label">Fecha de inicio</label>
                            <input type="date" class="form-control" id="fecha_inicio_nomina_palmilla"
                                name="fecha_inicio_nomina_palmilla" required>
                        </div>
                        <div class="col-md-6">
                            <label for="fecha_cierre_nomina_palmilla" class="form-label">Fecha de cierre</label>
                            <input type="date" class="form-control" id="fecha_cierre_nomina_palmilla"
                                name="fecha_cierre_nomina_palmilla" required>
                        </div>
                ...
                <div class="tab-pane fade" id="panel-recuperar-nomina" role="tabpanel"
                    ...
                    <form id="form_recuperar_nomina_palmilla" class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="anio_recuperar_nomina_palmilla"
                                name="anio_recuperar_nomina_palmilla" min="2000" max="2100" placeholder="Ej. 2026"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="semana_recuperar_nomina_palmilla" class="form-label">No. Semana</label>
                            <input type="number" class="form-control" id="semana_recuperar_nomina_palmilla"
                                name="semana_recuperar_nomina_palmilla" min="1" max="53" placeholder="Ej. 5" required>
                        </div>
                        <div class="col-12 d-flex justify-content-center mt-3">
                        ...
                        <div class="col-md-5 bg-light p-4 border-end">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="precio_pasaje_palmilla" class="form-control form-control-sm" placeholder="0.00" step="0.01" min="0">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" id="pago_tardeada_palmilla" class="form-control form-control-sm" placeholder="0.00" step="0.01" min="0">
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" id="pago_comida_palmilla" class="form-control form-control-sm" placeholder="0.00" step="0.01" min="0">
                                </div>
                            </div>
                        </div>
        ...
        <div class="controles-tabla-palmilla">
            <div class="filtros-container-palmilla">
                ...
                <div class="busqueda-container-palmilla" id="busqueda-container">
                    ...
                    <input type="text" class="campo-busqueda-palmilla" placeholder="Buscar..."
                        id="busqueda-nomina-palmilla">
