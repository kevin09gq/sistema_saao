...
<head>
    ...
    <link rel="stylesheet" href="../css/nomina_palmilla.css">
...
<body>
    ...
    <div class="container-nomina_palmilla" id="container-nomina_palmilla" hidden>
        <!-- Contenedor tipo navbar para formulario y filtros -->
        <div class="navbar-nomina_palmilla">
            <div class="titulo-nomina_palmilla">Procesamiento de Nómina palmilla</div>
            <div class="subtitulo-nomina_palmilla">Selecciona los archivos Excel para procesar la información</div>

            <form id="form_excel_raya" enctype="multipart/form-data" class="form-nomina-inline-palmilla">
                <div>
                    <label for="archivo_excel_lista_raya_palmilla">
                        <i class="bi bi-file-earmark-excel-fill"></i> Lista de Raya
                    </label>
                    <input type="file" id="archivo_excel_lista_raya_palmilla" name="archivo_excel_lista_raya_palmilla" accept=".xls,.xlsx" required>
                </div>
                <div>
                    <label for="archivo_excel_biometrico_palmilla">
                        <i class="bi bi-file-earmark-excel-fill"></i> Biometrico
                    </label>
                    <input type="file" id="archivo_excel_biometrico_palmilla" name="archivo_excel_biometrico_palmilla" accept=".xls,.xlsx" required>
                </div>
                <div>
                    <button type="button" id="btn_procesar_nomina_palmilla" class="btn-procesar-nomina_palmilla">
    ...
    <div id="container-acceso-palmilla" hidden>
        ...
        <div class="container mt-4" style="max-width: 600px;">
            ...
            <div class="tab-content border border-top-0 rounded-bottom p-4 shadow-sm bg-white" id="tabsAccesoHuastecaContent">
                ...
                <div class="tab-pane fade show active" id="panel-crear-nomina" role="tabpanel" aria-labelledby="tab-crear-nomina">
                    ...
                    <form id="form_crear_nomina_palmilla" class="row g-3">

                        <div class="col-md-6">
                            <label for="semana_nomina_palmilla" class="form-label">No. Semana</label>
                            <input type="number" class="form-control" id="semana_nomina_palmilla" name="semana_nomina_palmilla" min="1" max="53" placeholder="Ej. 5">
                        </div>
                        <div class="col-md-6">
                            <label for="fecha_inicio_nomina_palmilla" class="form-label">Fecha de inicio</label>
                            <input type="date" class="form-control" id="fecha_inicio_nomina_palmilla" name="fecha_inicio_nomina_palmilla">
                        </div>
                        <div class="col-md-6">
                            <label for="fecha_cierre_nomina_palmilla" class="form-label">Fecha de cierre</label>
                            <input type="date" class="form-control" id="fecha_cierre_nomina_palmilla" name="fecha_cierre_nomina_palmilla">
                        </div>
                        <div class="col-12 d-flex justify-content-center mt-3">
                            <button type="button" class="btn btn-success px-4" id="btn_crear_nomina_palmilla">
                ...
                <div class="tab-pane fade" id="panel-recuperar-nomina" role="tabpanel" aria-labelledby="tab-recuperar-nomina">
                    ...
                    <form id="form_recuperar_nomina_palmilla" class="row g-3">
                        <div class="col-md-6">
                            <label for="anio_recuperar_nomina_palmilla" class="form-label">Año</label>
                            <input type="number" class="form-control" id="anio_recuperar_nomina_palmilla" name="anio_recuperar_nomina_palmilla" min="2000" max="2100" placeholder="Ej. 2026">
                        </div>
                        <div class="col-md-6">
                            <label for="semana_recuperar_nomina_palmilla" class="form-label">No. Semana</label>
                            <input type="number" class="form-control" id="semana_recuperar_nomina_palmilla" name="semana_recuperar_nomina_palmilla" min="1" max="53" placeholder="Ej. 5">
                        </div>
                        <div class="col-12 d-flex justify-content-center mt-3">
                            <button type="button" class="btn btn-primary px-4" id="btn_recuperar_nomina_palmilla">
    ...
    <div class="container mt-5 mb-5" id="config-valores-palmilla" hidden>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="precio_pasaje_palmilla" class="form-label">Precio del Pasaje</label>
                            <input type="number" id="precio_pasaje_palmilla" class="form-control" placeholder="Ej. 50.00" step="0.01" min="0">
                        </div>
                        <div class="mb-3">
                            <label for="pago_tardeada_palmilla" class="form-label">Pago Tardeada</label>
                            <input type="number" id="pago_tardeada_palmilla" class="form-control" placeholder="Ej. 25.00" step="0.01" min="0">
                        </div>
                        <div class="mb-3">
                            <label for="pago_comida_palmilla" class="form-label">Pago Comida</label>
                            <input type="number" id="pago_comida_palmilla" class="form-control" placeholder="Ej. 25.00" step="0.01" min="0">
                        </div>
                        <div class="d-grid gap-2">
                            <button class="btn btn-primary btn-lg" id="btn_config_avanzar_palmilla" type="button">
    ...
    <div class="container-tabla-nomina-palmilla" id="tabla-nomina-responsive" hidden>
        ...
        <div class="controles-tabla-palmilla">
            <div class="filtros-container-palmilla">
                ...
                <select class="filtro-departamento-palmilla" id="filtro_departamento">
                    <!-- Departamento -->
                </select>

                <select class="filtro-departamento-palmilla" id="filtro_puesto">
                    <!-- Departamento -->
                </select>
        ...
        <div id="tabla-corte-container-palmilla" class="tabla-nomina-container-palmilla-corte" hidden>
            <div class="table-responsive-palmilla-corte">
                <table class="table-nomina-palmilla-corte" id="tabla-nomina-corte">
                    <thead>
                        <tr>
                            <th rowspan="2">#</th>
                            <th rowspan="2">NOMBRE</th>
                    ...
                    <tbody id="tabla-body-corte-palmilla">
                        <!-- Filas de la tabla se generarán dinámicamente -->
                    </tbody>
    ...
    <?php include "modal_seleccion_tickets_palmilla.php"; ?>
    ...
    <script src="../js/ticket_seleccion_palmilla.js"></script>
