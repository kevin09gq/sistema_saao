<!-- Modal para selección de empleados para tickets - Palmilla -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_seleccion_tickets_label">
                    <i class="bi bi-person-check"></i> Seleccionar Empleados para Tickets (Palmilla)
                </h5>
                ...
                <div class="mb-3">
                    <div class="mb-2">
                        ...
                        <div class="d-flex flex-wrap gap-2 mt-1 align-items-center">
                            ...
                            <select class="form-select form-select-sm w-auto" id="filtro_departamento_ticket_palmilla">
                    ...
                    <div class="position-relative w-100" style="display: flex; align-items: center;">
                        ...
                        <input type="text" class="form-control" id="buscar_empleado_ticket" placeholder="Buscar empleado..." style="padding-left: 40px !important; padding-right: 50px !important; border-radius: 8px !important; height: 45px;">
