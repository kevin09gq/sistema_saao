...
<head>
    ...
    <title>Historial Podas - Palmilla</title>
    ...
    <style>
        /* Estilos personalizados para Palmilla */
        .header-historial {
            background: linear-gradient(135deg, #1b5e20 0%, #32BA5B 100%) !important;
        }
        ...
        /* Color corporativo en cabeceras de tabla */
        #thead_historial tr th, 
        .table-custom-modal thead tr th {
            background-color: #32BA5B !important;
            color: white !important;
        }

        .kpi-box {
            border-left-color: #32BA5B !important;
        }
        ...
        .nav-pills .nav-link.active {
            background-color: #32BA5B !important;
            color: white !important;
            box-shadow: 0 4px 6px rgba(50, 186, 91, 0.2);
        }
