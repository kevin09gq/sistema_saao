...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#detalle-tabla-nomina-body-palmilla tr', function (e) {
...
function regresarHistorialPalmilla() {

    $('#btnRegresar').on('click', function () {
        // Redirigir a la vista historial_palmilla
        window.location.href = "historial_palmilla.php";

        // Limpiar el localStorage
        localStorage.removeItem('id_nomina_palmilla');
