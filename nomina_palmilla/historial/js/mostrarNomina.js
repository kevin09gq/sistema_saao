...
function obtenerIdNomina() {
    ...
    return parametros.get('id_nomina_palmilla');
...
function obtenerNomina() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonHistorialPalmilla = nomina.nomina_palmilla;
...
function llenarTablaNominaHistorial() {
    ...
    $('#detalle-tabla-nomina-body-palmilla').empty();

    // Obtener el departamento seleccionado
    let filtro = $('#detalle-filtro-departamento').val();

    // Obtener el texto escrito en el buscador
    let textoBusqueda = $('#detalle-busqueda-nomina-palmilla').val().trim().toUpperCase();
    ...
    jsonHistorialPalmilla.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#detalle-tabla-nomina-body-palmilla').append(`
    ...
    let deptoSeleccionado = jsonHistorialPalmilla.departamentos.find(d => d.id_departamento == idDepartamento);
    ...
    actualizarCabeceraNomina(jsonHistorialPalmilla)
...
function calcularTotalesPorColumna() {
    ...
    $('#detalle-tabla-nomina-foot-palmilla').empty();
    ...
    $('#detalle-tabla-nomina-foot-palmilla').append(`
        <tr>
