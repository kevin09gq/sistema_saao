...
function establecerDataEmpleado(empleado) {
    ...
    establecerEventosEntradasTempranas(empleado, jsonHistorialPalmilla);
    establecerEventosSalidasTardias(empleado, jsonHistorialPalmilla);
    establecerEventosSalidasTempranas(empleado, jsonHistorialPalmilla);
    establecerEventosRetardos(empleado, jsonHistorialPalmilla);
    establecerEventosAusentismos(empleado, jsonHistorialPalmilla);
    establecerEventosComidaExtra(empleado, jsonHistorialPalmilla);
    establecerEventosMarcajes(empleado, jsonHistorialPalmilla);
...
function ocultarComponentesModalDetalles(empleado) {
    ...
    let departamentoEmpleado = jsonHistorialPalmilla.departamentos.find(function (departamento) {
