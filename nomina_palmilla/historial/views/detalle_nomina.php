...
<head>
    ...
    <title>Historial Nomina Palmilla</title>
...
<body class="bg-secondary-subtle">
    ...
    <div class="container-tabla-nomina-palmilla" id="tabla-nomina-responsive">
        ...
        <div class="controles-tabla-palmilla">
            <div class="filtros-container-palmilla">
                <select class="filtro-departamento-palmilla" id="detalle-filtro-departamento">
                    <!-- Se poblará dinámicamente -->
                </select>

                <div class="busqueda-container-palmilla" id="detalle-busqueda-container">
                    <i class="bi bi-search"></i>
                    <input type="text" class="campo-busqueda-palmilla" placeholder="Buscar..." id="detalle-busqueda-nomina-palmilla">
        ...
        <div id="tabla-nomina-container-palmilla" class="tabla-nomina-container-palmilla">
            <div class="table-responsive-palmilla">
                <table class="table-nomina-palmilla" id="tabla-nomina">
                    ...
                    <tbody id="detalle-tabla-nomina-body-palmilla">
                        <!-- Filas de la tabla se generarán dinámicamente -->



                    </tbody>
                    <tfoot id="detalle-tabla-nomina-foot-palmilla">
