...
$(document).ready(function () {
    ...
    seleccionarDepartamentosAddConceptos();
        ...
        $('#tbody-empleados-add-conceptos').append(`
            <tr class="table-secondary">
                <td colspan="3" class="fw-bold">
                    <input 
                        type="checkbox"
                        class="form-check-input me-2 check-departamento-add-conceptos"
...
function seleccionarDepartamentosAddConceptos() {

    $('.check-departamento-add-conceptos').off('change').on('change', function () {

        let idDepartamento = $(this).data('departamento');
        let seleccionado = $(this).prop('checked');

        $(`.check-empleado-add-conceptos[data-departamento="${idDepartamento}"]`)
