...
function calcularPagoComidaEmpleado(empleado) {
    ...
    let pagoComida = parseFloat(jsonNominaHuasteca.pago_comida) || 0;
...
function calcularPagoPasajeEmpleado(empleado) {
    ...
    let precioPasaje = parseFloat(jsonNominaHuasteca.precio_pasaje) || 0;
...
function calcularTardeadaEmpleado(empleado) {
    ...
    if (
        ...
        jsonNominaHuasteca.horarioRancho.length === 0
    ) {
    ...
    empleado.registros.forEach(function(registro) {
        ...
        let horarioDia = jsonNominaHuasteca.horarioRancho.find(function(horario) {
    ...
    let pagoTardeada =
        parseFloat(jsonNominaHuasteca.pago_tardeada) || 0;
