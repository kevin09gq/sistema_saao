...
function llenarTablaNomina() {
    ...
    let textoBusqueda = $('#busqueda-nomina-huasteca').val().trim().toUpperCase();
    ...
    jsonNominaHuasteca.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#tabla-nomina-body-huasteca').append(`
    ...
    let deptoSeleccionado = jsonNominaHuasteca.departamentos.find(d => d.id_departamento == idDepartamento);
...
function calcularTotalesPorColumna() {
    ...
    $('#tabla-nomina-foot-huasteca').empty();
    ...
    $('#tabla-nomina-foot-huasteca').append(`
        <tr>
