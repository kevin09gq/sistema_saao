...
function calcularTotalSueldoExtra() {
    ...
    let tardeada = parseFloat($("#inputTardeada").val()) || 0;
...
//=================================================================
// FUNCIÓN PARA LIMITAR EL IMPORTE MÁXIMO DE LOS 
// CONCEPTOS TARJETA, ISR, IMSS, INFONAVIT Y AJUSTES AL SUBSIDIO
//=================================================================
...
function calcularTotalCobrar() {
    ...
    percepciones += parseFloat($("#inputSalarioSemanal").val()) || 0;
    percepciones += parseFloat($("#inputComida").val()) || 0;
    percepciones += parseFloat($("#inputPasaje").val()) || 0;
    ...
    deducciones += parseFloat($("#inputRetardos").val()) || 0;
