...
$(document).ready(function () {
    ...
    guardarConfiguracionHuasteca();

    // Limpiar la nómina y regresar a la vista de datos
    limpiarNominaHuasteca();
...
function obtenerInfoDepartamento(jsonNominaHuasteca) {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            respuesta.departamentos.forEach(depto => {
                ...
                // Agregar cada departamento al jsonNominaHuasteca 
            ...
            // Cambiar de vista a la configuración de valores económicos del huasteca
...
function obtenerHorarioRancho() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonNominaHuasteca.horarioRancho = respuesta.horario_jornalero;


            console.log(
                "Horario Rancho:",
                jsonNominaHuasteca.horarioRancho
            );
...
function cargarConfiguracionHorarios() {
    ...
    if (!jsonNominaHuasteca || jsonNominaHuasteca.departamentos.length === 0) {
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <div class="form-check form-check-inline">
                        <input
                            class="form-check-input horario-huasteca"
                            type="radio"
...
function guardarConfiguracionHuasteca() {

    // Evento del botón para continuar al procesamiento de la nómina
    $("#btn_config_avanzar_huasteca").click(function () {

        // Obtener los valores económicos
        var precioPasaje = parseFloat($("#precio_pasaje_huasteca").val()) || 0;
        var pagoTardeada = parseFloat($("#pago_tardeada_huasteca").val()) || 0;
        var pagoComida = parseFloat($("#pago_comida_huasteca").val()) || 0;

        // Guardar los valores en el JSON principal
        jsonNominaHuasteca.precio_pasaje = precioPasaje;
        jsonNominaHuasteca.pago_tardeada = pagoTardeada;
        jsonNominaHuasteca.pago_comida = pagoComida;
        ...
        obtenerEmpleados(jsonNominaHuasteca);
...
function obtenerEmpleados(jsonNominaHuasteca) {
