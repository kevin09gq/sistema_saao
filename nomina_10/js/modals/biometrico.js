...
function compararEmpleadosBiometrico(empleadosSeleccionados, empleadosBiometrico) {
    ...
    empleadosSeleccionados.forEach(function (empleadoSeleccionado) {

        // Buscar coincidencias por nombre
        let coincidencias = empleadosBiometrico.filter(function (empleadoBiometrico) {
        ...
        // SOLO EXISTE UN EMPLEADO CON ESE NOMBRE
        ...
        // BUSCAR POR ID BIOMETRICO
            ...
            coincidencias.forEach(function (empleadoBiometrico) {


                if (
                    empleadoSeleccionado.id_biometrico ==
                    empleadoBiometrico.id_biometrico
                ) {
...
// INDEPENDIENTEMENTE DEL FORMATO (APELLIDOS PRIMERO/NOMBRE PRIMERO)
//===================================================

function normalizarNombreEmpleadoBiometrico(nombre) {

    // Dividir el nombre en palabras, normalizar cada una, y ordenarlas alfabéticamente
    return nombre
        .trim()
        .toUpperCase()
        .replace(/\s+/g, ' ')
...
// AL EMPLEADO DENTRO DEL jsonNomina10lbs.
//===================================================
