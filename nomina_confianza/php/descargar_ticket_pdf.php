...
function renderTicketPdf($pdf, $emp, $extra, $meta) {
    ...
    $drawPrimeraHoja = function ($alturaContenido) use ($pdf, $dot, $pt, $text, $textB, $departamento, $fechaIngreso, $puesto, $salarioDiario, $sueldoSemanalHeader, $claveMostrar, $nombre, $semana, $esSinSeguro) {
