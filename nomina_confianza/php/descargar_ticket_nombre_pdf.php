...
$pdf->SetTitle('Tickets Nombre Confianza');
...
// Generar nombre del archivo con formato: NOMBRE_SEMANA_DEPARTAMENTO_CONFIANZA_AÑO (en mayúsculas)
...
if (empty($departamento)) {
    $filename = 'NOMBRE_SEM_' . $semana . '_CONFIANZA_' . $año . '.pdf';
} else {
    $filename = 'NOMBRE_SEM_' . $semana . '_' . strtoupper($departamento) . '_CONFIANZA_' . $año . '.pdf';
}
