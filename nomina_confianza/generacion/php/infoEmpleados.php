...
function guardarNomina(mysqli $conexion)
{
    ...
    $jsonNomina = $_POST['nomina_confianza'] ?? '';
    $anio = $_POST['anio'] ?? 0;
    ...
    $sqlCheck = "SELECT id_nomina_confianza FROM nomina_confianza 
    ...
    if ($resultadoCheck->num_rows > 0) {
        ...
        $idNomina = $fila['id_nomina_confianza'];

        $sqlUpdate = "UPDATE nomina_confianza 
        ...
        $sqlInsert = "INSERT INTO nomina_confianza 
                      (id_empresa, anio, numero_semana, nomina_confianza, total_percepciones, total_deducciones, total_neto)
                      VALUES (?, ?, ?, ?, ?, ?, ?)";
...
function recuperarUltimaNomina(mysqli $conexion)
{
    ...
    $sql = "SELECT id_nomina_confianza, anio, numero_semana, nomina_confianza,
    ...
    echo json_encode([
        "success" => true,
        "nomina_json" => $fila['nomina_confianza'],
        "nomina_info" => [
            "id_nomina_confianza" => $fila['id_nomina_confianza'],
            "anio" => $fila['anio'],
