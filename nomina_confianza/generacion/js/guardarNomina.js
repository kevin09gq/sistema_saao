...
function guardarNomina() {
    ...
    $('#btn_guardar_nomina_confianza').click(function (e) {
        e.preventDefault();
        ...
        const totales = calcularTotalesNomina(jsonNominaConfianza);
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Limpiamos los datos 
                eliminarPropiedades(jsonNominaConfianza);
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        nomina_confianza: JSON.stringify(jsonNominaConfianza),
                        anio: jsonNominaConfianza.anio,
