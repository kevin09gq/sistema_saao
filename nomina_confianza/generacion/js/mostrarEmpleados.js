...
function llenarTablaNomina() {
    ...
    let textoBusqueda = $('#busqueda-nomina-confianza').val().trim().toUpperCase();
    ...
    jsonNominaConfianza.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#tabla-nomina-body-confianza').append(`
...
function calcularTotalesPorColumna() {
    ...
    $('#tabla-nomina-foot-confianza').empty();
    ...
    $('#tabla-nomina-foot-confianza').append(`
        <tr>
