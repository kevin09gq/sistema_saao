...
function cargarDepartamentosExportar() {
    ...
    if (!jsonNominaConfianza) {
        console.error("No existe jsonNominaConfianza.");
        return;
    }
    ...
    if (
        ...
        console.error("No existen departamentos en jsonNominaConfianza.");
        return;
    }
...
function exportarNominaDepartamento() {
    ...
    $(document).on("click", ".btn-export-departamento", function (e) {
        ...
        const departamentoObj = jsonNominaConfianza.departamentos.find(
        ...
        $.ajax({
            ...
            success: function (blob) {
                ...
                const numeroSemana = String(jsonNominaConfianza.numero_semana).padStart(2, "0");
                const anioCierre = jsonNominaConfianza.fecha_cierre.split("/")[2];
