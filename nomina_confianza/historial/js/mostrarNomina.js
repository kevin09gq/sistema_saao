...
function obtenerIdNomina() {
    ...
    return parametros.get('id_nomina_confianza');
...
function obtenerNomina() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            jsonHistorialConfianza = nomina.nomina_confianza;
...
function llenarTablaNominaHistorial() {
    ...
    $('#detalle-tabla-nomina-body-confianza').empty();

    // Obtener el departamento seleccionado
    let filtro = $('#detalle-filtro-departamento').val();

    // Obtener el texto escrito en el buscador
    let textoBusqueda = $('#detalle-busqueda-nomina-confianza').val().trim().toUpperCase();
    ...
    jsonHistorialConfianza.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            if (contador >= inicio && contador < fin) {
                ...
                $('#detalle-tabla-nomina-body-confianza').append(`
    ...
    actualizarCabeceraNomina(jsonHistorialConfianza)
...
function calcularTotalesPorColumna() {
    ...
    $('#detalle-tabla-nomina-foot-confianza').empty();
    ...
    $('#detalle-tabla-nomina-foot-confianza').append(`
        <tr>
