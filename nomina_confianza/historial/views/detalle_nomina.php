...
<head>
    ...
    <title>Historial Nomina Confianza</title>
...
<body class="bg-secondary-subtle">
    ...
    <div class="container-tabla-nomina-confianza" id="tabla-nomina-responsive">
        ...
        <div class="controles-tabla-confianza">
            <div class="filtros-container-confianza">
                <select class="filtro-departamento-confianza" id="detalle-filtro-departamento">
                    <!-- Se poblará dinámicamente -->
                </select>

                <div class="busqueda-container-confianza" id="detalle-busqueda-container">
                    <i class="bi bi-search"></i>
                    <input type="text" class="campo-busqueda-confianza" placeholder="Buscar..." id="detalle-busqueda-nomina-confianza">
        ...
        <div id="tabla-nomina-container-confianza" class="tabla-nomina-container-confianza">
            <div class="table-responsive-confianza">
                <table class="table-nomina-confianza" id="tabla-nomina">
                    ...
                    <tbody id="detalle-tabla-nomina-body-confianza">
                        <!-- Filas de la tabla se generarán dinámicamente -->

                    </tbody>
                    <tfoot id="detalle-tabla-nomina-foot-confianza">
