...
function crearHistorialInasistenciasConfianza(empleado) {
...
function crearHistorialRetardosConfianza(empleado) {
    ...
    calcularDescuentoRetardosConfianza(empleado);
...
function calcularDescuentoRetardosConfianza(empleado) {
