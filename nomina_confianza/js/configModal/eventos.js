...
function recalcularEventos(empleado) {
    // Validar que sea confianza
    if (!empleado) {
        return;
    }
...
function calcularRetardosTodos(jsonNominaConfianza) {
    ...
    jsonNominaConfianza.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            // Calcular el historial de retardos para este confianza
            asignarHistorialRetardos(empleado);

            // Calcular y asignar el total de retardos a la propiedad
            asignarTotalRetardos(empleado, true); // force=true para asegurar la asignación
...
function calcularInasistenciasTodos(jsonNominaConfianza) {
    // Validar que exista la nómina y sus departamentos
    if (!jsonNominaConfianza || !Array.isArray(jsonNominaConfianza.departamentos)) {
        return;
    }
    ...
    jsonNominaConfianza.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            // Calcular el historial de inasistencias para este confianza
            asignarHistorialInasistencias(empleado);

            // Calcular y asignar el total de inasistencias a la propiedad
            asignarTotalInasistencias(empleado, true); // force=true para asegurar la asignación
...
function calcularOlvidosTodos(jsonNominaConfianza) {
    // Validar que exista la nómina y sus departamentos
    if (!jsonNominaConfianza || !Array.isArray(jsonNominaConfianza.departamentos)) {
        return;
    }
    ...
    jsonNominaConfianza.departamentos.forEach(departamento => {
        ...
        departamento.empleados.forEach(empleado => {
            ...
            // Calcular el historial de olvidos para este confianza
            asignarHistorialOlvidos(empleado);
...
// ========================================
function asignarTotalRetardos(empleado, force = false) {
...
function mostrarRetardos(empleado) {
    mostrarEventosPorEntrada(empleado, '#retardos-confianza', '#total-retardos-confianza',
...
function mostrarEntradasTempranas(empleado) {
    mostrarEventosPorEntrada(empleado, '#entradas-tempranas-confianza', '#total-entradas-tempranas-confianza',
...
function mostrarSalidasTardias(empleado) {
    mostrarEventosPorEntrada(empleado, '#salidas-tardias-confianza', '#total-salidas-tardias-confianza',
...
function mostrarSalidasTempranas(empleado) {
    mostrarEventosPorEntrada(empleado, '#salidas-tempranas-confianza', '#total-salidas-tempranas-confianza',
...
function mostrarInasistencias(empleado) {
    mostrarEventosPorEntrada(empleado, '#inasistencias-content-confianza', '#total-inasistencias-confianza',
        null, 'Sin inasistencias', 'inasistencia'
    );
}

function mostrarOlvidosChecador(empleado) {
    const $content = $('#olvidos-checador-confianza');
    $content.empty();
    ...
    $('#total-olvidos-checador-confianza').text(empleado.historial_olvidos.length);
}