        ...
        $.ajax({
            ...
            success: function (res) {
                try {
                    ...
                    unirBiometricoConSeleccionados(jsonNominaConfianza, JsonBiometrico, clavesSeleccionadas);
                    ...
                    clavesSeleccionadas.forEach(obj => {
                        ...
                        if (typeof recalcularEventos === 'function') {
                            recalcularEventos(emp);
                        }else{
                            console.warn('Función recalcularEventos no definida');
                        }
                    });
...
function obtenerEmpleadoPorClave(clave, id_empresa) {
    ...
    for (const depto of jsonNominaConfianza.departamentos) {
...
function unirBiometricoConSeleccionados(jsonNominaConfianza, JsonBiometrico, clavesSeleccionadas) {
    ...
    // Recorrer departamentos and actualizar SOLO empleados seleccionados
