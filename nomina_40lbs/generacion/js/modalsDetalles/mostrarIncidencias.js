//==========================================================
// FUNCIÓN AUXILIAR PARA OBTENER LOS HORARIOS SEMANALES
//==========================================================
function obtenerHorariosSemanales(dataNomina = null) {
    if (dataNomina && Array.isArray(dataNomina.horarios_semanales)) {
        return dataNomina.horarios_semanales;
    }
    if (Array.isArray(dataNomina)) {
        return dataNomina;
    }
    if (typeof jsonNomina40lbs !== 'undefined' && jsonNomina40lbs && Array.isArray(jsonNomina40lbs.horarios_semanales)) {
        return jsonNomina40lbs.horarios_semanales;
    }
    if (typeof jsonHistorial40lbs !== 'undefined' && jsonHistorial40lbs && Array.isArray(jsonHistorial40lbs.horarios_semanales)) {
        return jsonHistorial40lbs.horarios_semanales;
    }
    return [];
}
...
//==========================================================
function establecerEventosOlvidosBiometrico(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosEntradasTempranas(registros, dataNomina = null) {
    ...
    let horariosSemanales = obtenerHorariosSemanales(dataNomina);
    ...
    registros.forEach(function (registro) {
        ...
        let horario = horariosSemanales.find(function (item) {
...
//==========================================================
function establecerEventosSalidasTardias(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosSalidasTempranas(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosRetardos(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosAusentismos(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosComidaExtra(registros, dataNomina = null) {
...
//==========================================================
function establecerEventosMarcajes(registros, dataNomina = null) {
