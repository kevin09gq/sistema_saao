...
// (Solo incluye actividades_especiales y percepciones_extra)
//=====================================================================================
...
// DEL EMPLEADO (Solo incluye actividades_especiales y percepciones_extra)
//==========================================================
function calcularTotalSueldoExtra() {
    ...
    // Calcular total (solo actividades_especiales + percepciones_extra)
    let total = totalPercepcionesExtras;
...
function calcularTotalCobrar() {
    ...
    percepciones += parseFloat($("#inputHorasExtras").val()) || 0;
    percepciones += parseFloat($("#inputBonoAntiguedad").val()) || 0;
    percepciones += parseFloat($("#inputActividadesEspeciales").val()) || 0;
    percepciones += parseFloat($("#inputPuesto").val()) || 0;
