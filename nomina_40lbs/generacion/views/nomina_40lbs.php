...
<body class="bg-secondary-subtle">
        ...
        <div id="tabla-nomina-container-40lbs" class="tabla-nomina-container-40lbs">
            <div class="table-responsive-40lbs">
                <table class="table-nomina-40lbs" id="tabla-nomina">
                    ...
                    <tfoot id="tabla-nomina-foot-40lbs">
    ...
    <?php include 'modals/modalActualizarPercepciones.php'; ?>
    ...
    <script src="../js/modals/establecerSueldoNeto.js"></script>
    <script src="../js/modals/listaDeRaya.js"></script>
    <script src="../js/modals/biometrico.js"></script>
    <script src="../js/modals/horariosSemanal.js"></script>
    <script src="../js/modals/redondearHorarios.js"></script>
    <script src="../js/modals/incidencias.js"></script>
    <script src="../js/modals/establecerSueldoBase.js"></script>
    ...
    <script src="../js/modals/actualizarPercepciones.js"></script>
