...
function mostrarContextMenu() {
    ...
    $(document).on('contextmenu', '#detalle-tabla-nomina-body-40lbs tr', function (e) {
...
function regresarHistorial40lbs() {

    $('#btnRegresar').on('click', function () {
        // Redirigir a la vista historial_40lbs
        window.location.href = "historial_40lbs.php";

        // Limpiar el localStorage
        localStorage.removeItem('id_nomina_40lbs');
