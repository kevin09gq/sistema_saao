                ...
                departamentos.forEach((element) => {
                    opciones += `
                                <tr id="departamento-row-${element.id_departamento}" data-id="${element.id_departamento}">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-edit btn-edit-departamento" id="btn-edit-departamento-${element.id_departamento}" data-id="${element.id_departamento}" title="Editar"><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-sm btn-delete btn-delete-departamento" id="btn-delete-departamento-${element.id_departamento}" data-id="${element.id_departamento}" title="Eliminar"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>   
                        `;
